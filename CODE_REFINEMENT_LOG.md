...
- Rounds 1–161 are complete and pushed to `origin/main`; public Runtime changes
  are followed by their exact CLI dependency update.
- The current Runtime contract is `0d38d55a` (`fix(runtime): require tool
  invocation names`).
...
- Continue after Round 161 by auditing complete Runtime catalogs and CLI
