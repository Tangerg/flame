...
| Q5 | 对齐 Grok Build 的 TUI 体验 | 进行中 | 已收敛 Goal/Plan/Run/composer 信息层级；真实 PTY 移除遗留旧品牌标记；slash completion 在 80×24、36×18 与 36×10 都只使用 composer 上方空间，窄屏截断候选而不污染输入区 | `f77bb98`、`0c45695`、`a788455`、`d57bf3d`、本批提交 |
