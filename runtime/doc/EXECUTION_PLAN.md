...
| Q1 | 升级 Scope 与全部 direct dependency | 已完成 | Scope v0.12.0；Runtime/CLI 的 standalone 模块依赖已推进到 `ba21200`，Runtime 实际构建图同步前移 AWS SDK 与 pprof，其他 direct dependency 复核无更新，未消费的上游子图继续由 `go mod tidy` 收敛；workspace + standalone test/vet/build/tidy/verify；真实 DeepSeek Goal+Plan | `290ea4a`、`09f0ae8`、`a8a02b8`、`bff76b6`、`459a851`、`ba21200`、`bf6bce2` |
