...
func (r *binding) ListProviders(ctx context.Context, options CallOptions) (*protocol.Page[protocol.Provider], error) {
...
func (r *binding) UpdateProvider(ctx context.Context, request protocol.UpdateProviderRequest, options CommandOptions) (*protocol.Provider, error) {
...
func (r *binding) TestProvider(ctx context.Context, request protocol.TestProviderRequest, options CallOptions) (*protocol.ProviderTestResult, error) {
