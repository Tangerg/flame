...
func (r *binding) ListTools(ctx context.Context, options CallOptions) (*protocol.Page[protocol.ToolSpec], error) {
...
func (r *binding) InvokeTool(ctx context.Context, request protocol.InvokeToolRequest, options CommandOptions) (any, error) {
