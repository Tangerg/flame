...
type Config struct {
	...
	// disables agent-maintained memory without affecting user-editable FLAME.md.
	...
	// SessionStore persists Flame sessions. Required; the composition root injects
	...
	// KnowledgeStore persists the human-authored FLAME.md cascade for both the
