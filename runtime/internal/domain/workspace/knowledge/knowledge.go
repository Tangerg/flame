// Package knowledge defines Flame's human-authored long-term knowledge: the
// user-editable FLAME.md cascade. Agent-maintained memory (the mined fact ledger
...
// MaxDocumentBytes is the complete encoded size admitted for one FLAME.md.
...
// Scope selects one location in the human-authored FLAME.md cascade. The three
...
const (
	// ScopeCWD is the FLAME.md at the workspace resource root.
	ScopeCWD Scope = "cwd"
	// ScopeProjectRoot is the FLAME.md at the nearest project-discovery root.
	ScopeProjectRoot Scope = "projectRoot"
	// ScopeHome is the cross-project FLAME.md in the Runtime's user data root.
...
// Validate rejects a value that cannot identify a FLAME.md location.
