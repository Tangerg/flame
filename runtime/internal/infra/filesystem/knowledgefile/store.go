// Package knowledgefile persists the user- and project-scoped FLAME.md
...
// "FLAME.md" on disk; rendered through the knowledge store as a markdown
// blob consumed as project or user knowledge.
const knowledgeFileName = "FLAME.md"

const stagedFilePrefix = ".FLAME.md.flame-stage-"

const stagedRecoveryReadBatchSize = 128

// Store persists human-authored knowledge to markdown files:
//
//   - <cwd>/FLAME.md — workspace-local knowledge
//   - <project-root>/FLAME.md — project knowledge when the workspace is nested
//   - <data-dir>/FLAME.md — user scope (cross-project preferences)
//
