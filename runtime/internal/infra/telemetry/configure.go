// Package telemetry configures process-wide OpenTelemetry tracing, metrics,
// logging, and propagation for the runtime executable.
package telemetry
...
// Configure wires all three OpenTelemetry signals — Traces,
...
//
// Level comes from FLAME_LOG_LEVEL (debug|info|warn|error, default info) and
...
// FLAME_LOG_LEVEL would be ignored. It only adds the Enabled check; Handle /
...
// parseLogLevel maps a FLAME_LOG_LEVEL string onto an slog level, defaulting
