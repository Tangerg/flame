...
func (s *stubRuntime) QuiesceSession(sessionID string) error {
...
func (s *stubRuntime) Discard(sessionID string) error {
	s.discardedSandboxes = append(s.discardedSandboxes, sessionID)
	return s.sandboxErr
}
