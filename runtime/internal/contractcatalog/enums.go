...
var wireEnums = map[reflect.Type][]string{
	...
	reflect.TypeFor[protocol.HookEvent]():                         {string(protocol.HookEventPreToolUse), string(protocol.HookEventPostToolUse), string(protocol.HookEventUserPromptSubmit), string(protocol.HookEventSessionStart), string(protocol.HookEventPreCompact), string(protocol.HookEventStop), string(protocol.HookEventNotification)},
	...
	reflect.TypeFor[protocol.MCPHandshakeTimeoutType]():           {string(protocol.MCPHandshakeUnbounded), string(protocol.MCPHandshakeBounded)},
	...
	reflect.TypeFor[protocol.ProviderCredentialRequirement]():     {string(protocol.ProviderAPIKeyRequired), string(protocol.ProviderAPIKeyOptional)},
	...
	reflect.TypeFor[protocol.RunOutcomeType]():                    {string(protocol.OutcomeCompleted), string(protocol.OutcomeTimedOut), string(protocol.OutcomeFailed), string(protocol.OutcomeCanceled), string(protocol.OutcomeLost)},
