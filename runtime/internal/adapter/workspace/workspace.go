...
// the default branch.
func Diff(ctx context.Context, root, relPath string, base bool, maxFiles, maxRows, maxBytes int) (git.DiffResult, error) {
...
func RawDiff(ctx context.Context, root, relPath string, base bool, maxBytes int) (git.RawDiffResult, error) {
