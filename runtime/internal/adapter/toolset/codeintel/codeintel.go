// Package codeintel adapts language-server connections (infra/integration/lsp) into
...
// rather than importing infra/integration/lsp directly.
package codeintel
...
import (
	...
	"github.com/Tangerg/flame/runtime/internal/infra/integration/lsp"
)

// ServerSpec is code intelligence's own configuration contract. The adapter
// translates it to infra/integration/lsp only when constructing its client set.
