...
> 协议权威定义看 `runtime/doc/API.md` + `runtime/doc/AUX_API.md` + `runtime/doc/TRANSPORT.md`。
>
...
> [`runtime/doc/AUX_API.md`](../../runtime/doc/AUX_API.md) 与
> [`runtime/doc/TRANSPORT.md`](../../runtime/doc/TRANSPORT.md)，勿在本文重述。
...
| 协议 method 表 / envelope / 语义                            | `runtime/doc/API.md` + `runtime/doc/AUX_API.md`                                     |
| transport / handshake / 错误码                              | `runtime/doc/TRANSPORT.md`                                                              |
