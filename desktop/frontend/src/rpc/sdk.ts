// Flame Runtime Protocol SDK — the one ergonomic entry point.
//
// The protocol is transport-agnostic (runtime/doc/TRANSPORT.md): the same JSON-RPC
...
/** Build a Flame Runtime Protocol client over the given transport. */
