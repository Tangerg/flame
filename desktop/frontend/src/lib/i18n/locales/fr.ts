export const fr: Record<string, string> = {
  ...
  "settings.connection.clearToken": "Effacer le jeton",
  "settings.connection.token": "Jeton d’accès",
  "settings.connection.tokenPlaceholder": "Saisir ou remplacer le jeton",
  "settings.connection.tokenHint":
    "Conservé uniquement dans cette fenêtre pour cette adresse Runtime. Effacé au rechargement.",
  ...
  "session.directory.description":
    "Saisissez un répertoire sur le Runtime à {{endpoint}}. Flame le vérifie avant de créer la session.",
  "session.directory.path": "Répertoire du Runtime",
  "session.directory.create": "Créer la session",
  "session.directory.browse": "Parcourir cet ordinateur",
  ...
  "diff.worktree.open_one": "Relire {{count}} fichier modifié de l’arbre de travail",
  "diff.worktree.open_many": "Relire {{count}} de fichiers modifiés de l’arbre de travail",
  "diff.worktree.open_other": "Relire {{count}} fichiers modifiés de l’arbre de travail",
  "diff.status.added": "Ajouté",
  "diff.status.modified": "Modifié",
  "diff.status.deleted": "Supprimé",
  "diff.status.renamed": "Renommé",
  "diff.status.untracked": "Non suivi",
  "diff.nav.picker": "Aller au fichier",
  "diff.nav.filter": "Filtrer les fichiers modifiés",
  "diff.nav.none": "Aucun fichier modifié ne correspond",
  "diff.nav.previous": "Fichier précédent",
