...
export const fr: Record<string, string> = {
  ...
  "tools.output.showSome": "Afficher {{count}} lignes sur {{total}}",
  "tools.output.beyond_one": "{{count}} ligne de plus — ouvrir dans la vue Terminal",
  "tools.output.beyond_many": "{{count}} de lignes de plus — ouvrir dans la vue Terminal",
  "tools.output.beyond_other": "{{count}} lignes de plus — ouvrir dans la vue Terminal",
  ...
  "terminal.commands_one": "{{count}} commande",
  "terminal.commands_many": "{{count}} de commandes",
  "terminal.commands_other": "{{count}} commandes",
  ...
  // ── Fichiers modifiés ──
  "files.changed_one": "{{count}} fichier modifié",
  "files.changed_many": "{{count}} de fichiers modifiés",
  "files.changed_other": "{{count}} fichiers modifiés",
  "files.uncommitted_one": "{{count}} fichier · non validé",
  "files.uncommitted_many": "{{count}} de fichiers · non validés",
  "files.uncommitted_other": "{{count}} fichiers · non validés",
  "files.binary": "bin",
