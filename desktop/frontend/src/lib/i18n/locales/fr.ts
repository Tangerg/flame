export const fr: Record<string, string> = {
  ...
  "providers.setup.steps": "Choisissez un fournisseur, collez sa clé API puis « Enregistrer et tester ». C’est tout ce qu’il faut pour commencer.",
  "providers.setup.done": "Un fournisseur est prêt. Utilisez « Retour à l’app » : votre brouillon est toujours là.",
  ...
  "startup.failed.body": "Un problème est survenu avant que la fenêtre soit prête. Réessayez ou copiez le diagnostic pour le signaler.",
  ...
  "settings.notifications.permission.granted": "Affichées quand une exécution se termine, échoue ou vous attend pendant que Flame est en arrière-plan.",
  "settings.notifications.permission.default": "Flame demandera l’autorisation la première fois qu’il aura quelque chose à vous signaler.",
  "settings.notifications.permission.denied": "Bloquées par le système. Autorisez Flame dans Réglages Système › Notifications.",
  "settings.notifications.permission.unsupported": "Cette plateforme ne propose pas de notifications système.",
