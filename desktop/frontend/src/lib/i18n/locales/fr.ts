...
export const fr: Record<string, string> = {
  ...
  "tool.label.generic": "Outil",
  "tool.label.readShellOutput": "Lire la sortie",
  "tool.label.stopShell": "Arrêter la commande",
  "tool.label.webSearch": "Recherche web",
  "tool.label.webFetch": "Récupérer la page",
  "tool.label.httpRequest": "Requête HTTP",
  "tool.label.loadSkill": "Charger la compétence",
  "tool.label.readSkillResource": "Fichier de compétence",
  "tool.label.proposeSkill": "Proposer une compétence",
  "tool.label.delegateTask": "Déléguer",
  "tool.label.askUser": "Demander",
  "tool.label.searchMemory": "Chercher en mémoire",
  "tool.label.searchConversations": "Chercher la conversation",
  "tool.label.searchTools": "Trouver un outil",
  "tool.label.createSchedule": "Planifier",
  "tool.label.deleteSchedule": "Supprimer la planification",
  "tool.label.createGoal": "Définir l'objectif",
  "tool.label.getGoal": "Lire l'objectif",
  "tool.label.reportGoalOutcome": "Rapporter l'objectif",
