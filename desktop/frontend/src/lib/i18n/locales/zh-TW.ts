export const zhTW: Record<string, string> = {
  ...
  "goal.stopped.runBudget": "已達執行次數上限",
  "goal.stopped.costBudget": "已達成本上限",
  "goal.stopped.stepBudget": "已達步數上限",
  "goal.stopped.pricingUnavailable": "模型價格無法取得",
