export const zhTW: Record<string, string> = {
  ...
  "composer.model.inputModalities": "輸入 {{modalities}}",
  "composer.model.outputModalities": "輸出 {{modalities}}",
  "composer.model.reasoning": "支援思考",
  "composer.model.reasoningLevels": "思考 {{levels}}",
  "composer.model.toolUse": "工具呼叫",
  "composer.model.structuredOutput": "結構化輸出",
  "composer.model.knowledgeCutoff": "知識截至 {{cutoff}}",
  "composer.attachImage": "新增圖片",
  "composer.attachImage.unsupported": "此模型不支援圖片",
  "composer.action.send": "傳送",
  "composer.action.stop": "停止",
  "composer.paste.lines_other": "已貼上 · {{count}} 行",
  "composer.paste.chars_other": "已貼上 · {{count}} 字元",
  ...
  "message.mermaid.copy": "複製 Mermaid",
  "message.mermaid.copied": "已複製",
  "message.mermaid.source": "Mermaid 原始碼",
  ...
  "message.table.expand": "展開表格",
  "message.table.preview": "表格預覽",
  "message.table.closePreview": "關閉表格預覽",
  ...
  "tools.patch.created": "已建立",
  "tools.patch.edited": "已編輯",
  "tools.patch.deleted": "已刪除",
  "tools.patch.moved": "已移動",
  ...
  "tools.http.headers_other": "{{count}} 個回應標頭",
  "inbox.title": "收件匣",
  ...
  "goal.summary.active": "進行中的目標",
  "goal.summary.paused": "目標已暫停",
  "goal.summary.blocked": "目標停滯",
  "goal.summary.completing": "目標收尾中",
  "goal.mode.label": "Goal",
  "goal.mode.clear": "退出 Goal 模式",
  "goal.action.pause": "暫停目標",
  "goal.action.resume": "恢復目標",
  "goal.action.clear": "清除目標",
  "goal.action.edit": "編輯目標",
  "goal.edit.title": "編輯目標",
  "goal.edit.label": "目標",
  "goal.edit.save": "儲存",
  "goal.edit.saving": "正在儲存…",
  "goal.error.start": "無法開啟目標模式",
  "goal.error.attachmentsUnsupported": "Goal 目標暫不支援附件",
  "goal.error.pause": "無法暫停目標",
  "goal.error.resume": "無法繼續目標",
  "goal.error.clear": "無法清除目標",
  "goal.error.update": "無法更新目標",
  "slash.goal": "設定一個讓智慧代理持續追求的目標",
  "goal.error.unavailable": "現在無法設定目標 —— 該執行環境可能不支援目標，或者已有一個在執行",
  "goal.replace.title": "替換目前的目標？",
  "goal.replace.body": "「{{objective}}」將就此結束，對話會保留。",
  "goal.replace.confirm": "替換目標",
  "tools.grep.matchCount_other": "{{count}} 處",
  "tools.overflow.matches_other": "還有 {{count}} 個相符項",
  "tools.output.label": "工具輸出",
  "tools.output.copy": "複製輸出",
  "tools.output.copied": "已複製",
  "tools.output.collapse": "收合",
  "tools.overflow.truncated": "已被執行環境截斷",
  "tools.group.calls_other": "{{count}} 次呼叫",
  "common.remove": "移除",
  "common.loading": "載入中",
  "common.retry": "重試",
  "tasks.header": "工作",
  ...
  "status.notifications.unread_other": "{{count}} 則未讀通知",
  ...
  "settings.font.ui": "介面字型",
  "settings.font.ui.sub": "標籤、選單和按鈕使用的字型。",
  "settings.font.code": "程式碼字型",
  "settings.font.code.sub": "差異、終端機和程式碼區塊使用的字型。",
  "settings.font.size": "介面字級",
  "settings.font.size.sub": "全域內文字級基準。",
  "settings.font.smoothing": "字型平滑",
  "settings.font.smoothing.sub": "macOS 反鋸齒。筆畫更細，邊緣更柔和。",
  ...
  "settings.connection.sub": "Flame Runtime 的位址。套用後桌面端將切換連線。",
  ...
  "settings.connection.status.unhealthy": "無法使用",
  "settings.connection.status.unavailable": "無法連線",
  "settings.connection.status.timeout": "Runtime 未能及時回應。",
  "settings.connection.status.refresh": "重新整理",
  "settings.connection.status.server": "服務",
  "settings.connection.status.protocol": "協定",
  "settings.connection.status.checks": "異常檢查",
  ...
  "approval.action.allowSession": "在此工作階段允許",
  "approval.action.allowProject": "在此專案允許",
  "approval.action.allowGlobal": "一律允許",
  "approval.action.deny": "拒絕",
  "approval.args.label": "參數",
  "approval.args.edit": "編輯",
  "approval.args.invalid": "JSON 格式錯誤 —— 請修正或拒絕",
  "question.progress": "{{current}} / {{total}}",
  "question.recommended": "推薦",
  "question.action.previous": "上一個問題",
  "question.action.next": "下一個問題",
  "question.action.skip": "略過",
  "question.action.advance": "下一步",
  "question.settled.asked": "已詢問",
  "question.settled.question_other": "{{count}} 個問題",
  ...
  "timeline.latestCalls": "最新呼叫",
  "timeline.olderCalls": "更早呼叫",
  "timeline.modelCall.started": "呼叫中",
  "timeline.modelCall.completed": "已完成",
  "timeline.modelCall.failed": "失敗",
  "timeline.modelCall.unknown": "結果未知",
  "timeline.recentWindow": "目前顯示最近 {{count}} 筆記錄",
  "timeline.kind.compaction": "上下文已壓縮",
  "timeline.executionDuration": "執行耗時（不含審批等待）",
  "timeline.kind.runStart": "執行開始",
  "timeline.kind.runEnd": "執行結束",
  "timeline.kind.runError": "執行錯誤",
  "timeline.kind.toolStart": "工具開始",
  ...
  "search.aria": "搜尋模式",
  "search.scope": "在工作階段工作區中使用正則搜尋",
  "search.prompt.title": "搜尋此工作區",
  "search.matches_other": "{{count}} 個相符項",
  "search.overflow_other": "還有 {{count}} 個相符項未顯示 —— 請縮小查詢範圍。",
  ...
  "skills.tab.review": "審核",
  "skills.tab.library": "個人庫",
  ...
  "knowledge.empty.sub": "執行時為 agent 維護的 FLAME.md 檔案會顯示在這裡。",
  ...
  "file.error.sub": "它可能已移動，或位於工作區之外。",
  ...
  "convExport.notFlame": "非 Flame 工作階段匯出 —— 請選擇透過「匯出對話」匯出的 JSON 檔案。",
  ...
  "settings.appearance.hero": "主題、對比、字體與動態決定了 Flame 的操作手感。",
  "context.usage.aria": "上下文用量：{{percent}}%",
  "context.usage.label": "上下文視窗：",
  "context.usage.statusFull": "已使用 {{percent}}%",
  "context.usage.statusLeft": "已使用 {{percent}}%（剩餘 {{remaining}}%）",
  "context.usage.tooltip": "已使用 {{used}} 個權杖，共 {{window}} 個",
  "usage.range.all": "全部",
  ...
  "usage.reasoning": "推理",
  "usage.sessions_other": "{{count}} 個工作階段",
  "usage.runs_other": "{{count}} 次執行",
  ...
  "hooks.intro":
    "Hooks 會在回合中的固定時點執行你自己的命令 —— 工具執行前、提示之後、壓縮時。全域 hooks（~/.flame）一律執行；專案的 hooks 只有在你信任它之後才會執行。",
  ...
  "hooks.empty.sub": "在 ~/.flame/hooks.json（全域）或 <project>/.flame/hooks.json 中新增 hooks。",
  ...
  "mcp.importing": "正在匯入…",
  "mcp.import.ok_other": "已匯入 {{count}} 個伺服器",
  ...
  "rpcError.denied_by_user": "你拒絕了這個操作。",
  ...
  "rpcError.skill_not_found": "該技能已不在程式庫中。",
  "rpcError.skill_unavailable": "該技能的文件無法讀取——請檢查它指向的檔案。",
  "rpcError.revision_conflict": "已有他人先一步變更——請重新載入後再試。",
  "rpcError.mcp_server_not_found": "該伺服器已不在設定中。",
  "rpcError.mcp_server_already_exists": "同名伺服器已設定。",
  "rpcError.mcp_server_disabled": "該伺服器已關閉——請先啟用。",
  "rpcError.schedule_not_found": "該排程已不存在。",
  "rpcError.path_outside_root": "該路徑在工作階段的工作目錄之外。",
  "rpcError.unsupported_mime": "這裡不支援該檔案類型。",
  ...
  "composer.error.readImages_other": "無法讀取 {{count}} 張圖片",
  "tool.action.generic": "呼叫工具",
  "tool.action.shell": "執行命令",
  "tool.action.readShellOutput": "讀取輸出",
  "tool.action.stopShell": "停止命令",
  "tool.action.read": "讀取檔案",
  "tool.action.applyPatch": "套用修補",
  "tool.action.grep": "搜尋文字",
  "tool.action.glob": "尋找檔案",
  "tool.action.lsp": "檢查程式碼",
  "tool.action.webSearch": "搜尋網頁",
  "tool.action.webFetch": "擷取網頁",
  "tool.action.httpRequest": "傳送請求",
  "tool.action.listSkills": "列出技能",
  "tool.action.loadSkill": "載入技能",
  "tool.action.readSkillResource": "讀取技能檔案",
  "tool.action.proposeSkill": "提議技能",
  "tool.action.delegateTask": "委派任務",
  "tool.action.askUser": "詢問使用者",
  "tool.action.enterPlanMode": "進入計畫模式",
  "tool.action.setPlan": "更新計畫",
  "tool.action.exitPlanMode": "請求核准計畫",
  "tool.action.searchMemory": "搜尋記憶",
  "tool.action.searchConversations": "搜尋對話",
  "tool.action.searchTools": "尋找工具",
  "tool.action.readToolResult": "讀取已存輸出",
  "tool.action.listSchedules": "列出排程",
  "tool.action.createSchedule": "建立排程",
  "tool.action.deleteSchedule": "刪除排程",
  "tool.action.createGoal": "建立目標",
  "tool.action.getGoal": "讀取目標",
  "tool.action.reportGoalOutcome": "回報目標結果",
  "tool.doing.generic": "正在使用工具",
  "tool.done.generic": "使用工具",
  "tool.doing.shell": "正在執行",
  "tool.done.shell": "執行",
  "tool.doing.readShellOutput": "正在讀取輸出",
  "tool.done.readShellOutput": "讀取輸出",
  "tool.doing.stopShell": "正在停止命令",
  "tool.done.stopShell": "停止命令",
  "tool.doing.read": "正在讀取",
  "tool.done.read": "讀取",
  "tool.doing.applyPatch": "正在套用修補",
  "tool.done.applyPatch": "套用修補",
  "tool.doing.grep": "正在搜尋",
  "tool.done.grep": "搜尋",
  "tool.doing.glob": "正在尋找檔案",
  "tool.done.glob": "尋找檔案",
  "tool.doing.lsp": "正在分析程式碼",
  "tool.done.lsp": "分析程式碼",
  "tool.doing.webSearch": "正在搜尋網路",
  "tool.done.webSearch": "搜尋網路",
  "tool.doing.webFetch": "正在取得網頁",
  "tool.done.webFetch": "取得網頁",
  "tool.doing.httpRequest": "正在發起請求",
  "tool.done.httpRequest": "發起請求",
  "tool.doing.listSkills": "正在列出技能",
  "tool.done.listSkills": "列出技能",
  "tool.doing.loadSkill": "正在載入技能",
  "tool.done.loadSkill": "載入技能",
  "tool.doing.readSkillResource": "正在讀取技能檔案",
  "tool.done.readSkillResource": "讀取技能檔案",
  "tool.doing.proposeSkill": "正在提議技能",
  "tool.done.proposeSkill": "提議技能",
  "tool.doing.delegateTask": "正在呼叫子代理",
  "tool.done.delegateTask": "呼叫子代理",
  "tool.doing.askUser": "正在提問",
  "tool.done.askUser": "提問",
  "tool.doing.enterPlanMode": "正在進入計劃模式",
  "tool.done.enterPlanMode": "進入計劃模式",
  "tool.doing.setPlan": "正在更新計劃",
  "tool.done.setPlan": "更新計劃",
  "tool.doing.exitPlanMode": "正在請求計劃批准",
  "tool.done.exitPlanMode": "請求計劃批准",
  "tool.doing.searchMemory": "正在檢索記憶",
  "tool.done.searchMemory": "檢索記憶",
  "tool.doing.searchConversations": "正在檢索對話",
  "tool.done.searchConversations": "檢索對話",
  "tool.doing.searchTools": "正在尋找工具",
  "tool.done.searchTools": "尋找工具",
  "tool.doing.readToolResult": "正在讀取暫存輸出",
  "tool.done.readToolResult": "讀取暫存輸出",
  "tool.doing.listSchedules": "正在列出排程",
  "tool.done.listSchedules": "列出排程",
  "tool.doing.createSchedule": "正在建立排程",
  "tool.done.createSchedule": "建立排程",
  "tool.doing.deleteSchedule": "正在刪除排程",
  "tool.done.deleteSchedule": "刪除排程",
  "tool.doing.createGoal": "正在設定目標",
  "tool.done.createGoal": "設定目標",
  "tool.doing.getGoal": "正在讀取目標",
  "tool.done.getGoal": "讀取目標",
  ...
  "composer.image.preview": "檢視圖片",
  "composer.paste.review": "檢視貼上的文字",
  "composer.paste.title": "貼上的文字",
  "composer.paste.save": "儲存",
  "composer.paste.restore": "放回輸入框",
  "composer.mention.status.loading": "正在載入專案檔案…",
  "composer.mention.status.empty": "沒有相符的檔案",
  "composer.mention.status.error": "無法列出專案檔案",
  "composer.mention.status.no-workspace": "選擇專案後才能引用其檔案",
  "providers.apiKey.label": "API 金鑰",
  "providers.baseUrl.label": "基礎 URL",
  "providers.baseUrl.labelRequired": "基礎 URL · 必填",
  "providers.baseUrl.required": "此供應商需要填寫基礎 URL 才能儲存。",
  "providers.saveAndTest": "儲存並測試",
  "providers.saved": "已儲存",
  "providers.role.loadError": "無法載入此設定，目前的值未知。",
  "providers.role.stale": "顯示的是最後已知的值——重新整理失敗。",
  "providers.setup.steps":
    "選一個供應商，貼上它的 API 金鑰，然後按「儲存並測試」。開始使用只需要這一步。",
  "providers.setup.done": "供應商已就緒。按「返回應用程式」即可回去——你的草稿仍在。",
  "providers.roles.heading": "模型角色",
  "settings.search.empty": "沒有與「{{query}}」相符的設定。",
  "settings.search.clear": "清除搜尋",
  "startup.failed.title": "Flame 無法啟動",
  "startup.failed.body": "視窗就緒前發生了錯誤。請重試，或複製診斷資訊回報。",
  "startup.failed.copy": "複製診斷資訊",
  "startup.failed.copied": "已複製",
  "plugins.renderFailed.details": "詳情",
  "settings.notifications": "系統通知",
  "settings.notifications.authorization.granted":
    "Flame 在背景時，執行完成、失敗或需要你處理時會顯示通知。",
  "settings.notifications.authorization.default": "Flame 會在第一次需要通知你時請求權限。",
  "settings.notifications.authorization.denied":
    "已被系統阻擋。請在「系統設定 › 通知」中允許 Flame 後再開啟。",
  "settings.notifications.authorization.unsupported": "此平台不支援系統通知。",
  "notify.finished.title": "{{product}} 已完成",
  "notify.finished.body": "代理已完成本輪任務。",
  "notify.needsInput.title": "{{product}} 需要你處理",
  "notify.needsInput.body": "代理正在等待你的核准或回答。",
  "notify.error.title": "{{product}} 發生錯誤",
  "notify.error.body": "代理執行失敗。",
  "notify.canceled.title": "{{product}} 已停止",
  "notify.canceled.body": "代理執行已取消。",
  "tools.read.notRecorded": "這次讀取的內容沒有被記錄。開啟目前的檔案可查看它現在的樣子。",
  "tool.open.currentFile": "開啟目前的檔案",
  "tool.open.worktreeDiff": "開啟工作區差異",
  "tools.overflow.lines_other": "還有 {{count}} 行",
  "tools.output.earlier_other": "顯示前面 {{count}} 行 · 共 {{total}} 行",
  "tools.output.latest": "跳到最新",
  "message.user.unfold": "顯示完整訊息",
  "message.user.fold": "收合",
  "composer.steer.hint": "送出後會補充到正在執行的任務中。",
  "message.mermaid.fit": "符合視窗",
  "message.mermaid.zoomIn": "放大圖表",
  "message.mermaid.zoomOut": "縮小圖表",
  "file.range": "第 {{start}}–{{end}} 行，共 {{total}} 行",
  "file.copyPath": "複製路徑",
  "file.reveal": "在 Finder 中顯示",
  "file.goToLine": "跳至行",
  "file.goToLine.placeholder": "行號",
  "file.mode": "檔案檢視",
  "file.mode.rendered": "預覽",
  "file.mode.source": "原始碼",
  "file.loadEarlier_other": "顯示前面 {{count}} 行",
  "file.loadLater_other": "再顯示 {{count}} 行",
  "quote.selection": "引用到訊息",
  "diff.worktree.open_other": "檢視工作區中 {{count}} 個已變更的檔案",
  "diff.status.added": "新增",
  "diff.status.modified": "修改",
  "diff.status.deleted": "刪除",
  "diff.status.renamed": "重新命名",
  "diff.status.untracked": "未追蹤",
  "diff.nav.picker": "跳至檔案",
  "diff.nav.filter": "篩選已變更的檔案",
  "diff.nav.none": "沒有相符的已變更檔案",
  "diff.nav.previous": "上一個檔案",
  "diff.nav.next": "下一個檔案",
  "diff.nav.collapseAll": "收合所有檔案",
  "diff.nav.expandAll": "展開所有檔案",
  "search.scope.placeholder": "資料夾或檔案，例如 src/",
  "search.scope.aria": "搜尋範圍",
  "search.narrow": "縮小到某個資料夾",
  "session.row.more": "「{{title}}」的更多動作",
  "project.row.waiting_other": "{{count}} 個待處理",
  "settings.font.codeSize": "程式碼字級",
  "settings.font.codeSize.sub": "程式碼區塊、差異與工具輸出。導覽與控制項維持介面字級。",
  "settings.font.followUi": "跟隨介面",
  "dock.action.openFull": "以全寬開啟材料——視窗太窄，無法與對話並排顯示",
  "composer.add": "新增到訊息",
  ...
  "model.effort.none": "關閉",
  "model.effort.minimal": "極低",
  "model.effort.low": "低",
  "model.effort.medium": "中",
  "model.effort.high": "高",
  "model.effort.xhigh": "極高",
  "model.effort.max": "最高",
  "tools.output.find": "在輸出中尋找",
  "tools.output.find.none": "無相符項目",
  "tools.output.find.count": "第 {{index}} / {{total}} 處",
  "tools.output.find.previous": "上一個相符項目",
  "tools.output.find.next": "下一個相符項目",
  "tools.output.find.close": "關閉尋找",
  "common.clear": "清除",
  "file.unsupported.image": "這裡暫時無法預覽圖片",
  "file.unsupported.binary": "這不是文字檔",
  "file.unsupported.sub":
    "Flame 以文字方式顯示工作區檔案。可以用預設 App 開啟，或在 Finder 中查看。",
  "file.open": "打開",
