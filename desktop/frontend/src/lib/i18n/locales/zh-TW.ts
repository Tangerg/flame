...
export const zhTW: Record<string, string> = {
  ...
  "tool.label.readShellOutput": "讀取輸出",
  "tool.label.stopShell": "停止命令",
  "tool.label.webSearch": "搜尋網路",
  "tool.label.webFetch": "取得網頁",
  "tool.label.httpRequest": "發起請求",
  "tool.label.loadSkill": "載入技能",
  "tool.label.readSkillResource": "技能檔案",
  "tool.label.proposeSkill": "提議技能",
  "tool.label.delegateTask": "呼叫子代理",
  "tool.label.askUser": "提問",
  "tool.label.searchMemory": "檢索記憶",
  "tool.label.searchConversations": "檢索對話",
  "tool.label.searchTools": "尋找工具",
  "tool.label.createSchedule": "建立排程",
  "tool.label.deleteSchedule": "刪除排程",
  "tool.label.createGoal": "設定目標",
  "tool.label.getGoal": "讀取目標",
  "tool.label.reportGoalOutcome": "回報目標",
  "tool.label.read": "讀取",
  "tool.label.edit": "編輯",
  "tool.label.write": "寫入",
