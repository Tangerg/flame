export const zhTW: Record<string, string> = {
  ...
  "providers.setup.steps": "選一個供應商，貼上它的 API 金鑰，然後按「儲存並測試」。開始使用只需要這一步。",
  ...
  "settings.notifications.permission.granted": "Flame 在背景時，執行完成、失敗或需要你處理時會顯示通知。",
  "settings.notifications.permission.default": "Flame 會在第一次需要通知你時請求權限。",
  "settings.notifications.permission.denied": "已被系統阻擋。請在「系統設定 › 通知」中允許 Flame 後再開啟。",
