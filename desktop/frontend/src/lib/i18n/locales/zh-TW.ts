export const zhTW: Record<string, string> = {
  ...
  "composer.mention.truncated": "僅在此專案的前 {{count}} 個檔案中搜尋",
  ...
  "settings.notifications.permission.default": "Flame 會在第一次需要通知你時請求權限。",
  "settings.notifications.permission.denied":
    "已被系統阻擋。請在「系統設定 › 通知」中允許 Flame 後再開啟。",
  "settings.notifications.permission.unsupported": "此平台不支援系統通知。",
