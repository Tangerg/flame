export const zhTW: Record<string, string> = {
  ...
  "settings.connection.clearToken": "清除權杖",
  "settings.connection.token": "存取權杖",
  "settings.connection.tokenPlaceholder": "輸入或取代權杖",
  "settings.connection.tokenHint": "只在目前視窗中為此 Runtime 位址保留，重新整理後清除。",
  ...
  "session.directory.description":
    "輸入 {{endpoint}} 上 Runtime 的工作區目錄。Flame 會在建立對話前驗證目錄。",
  "session.directory.path": "Runtime 工作區目錄",
  "session.directory.create": "建立對話",
  "session.directory.browse": "瀏覽此電腦",
