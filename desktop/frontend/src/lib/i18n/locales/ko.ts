export const ko: Record<string, string> = {
  ...
  "providers.setup.steps": "공급자 하나를 고르고 API 키를 붙여넣은 뒤 ‘저장 후 테스트’를 누르세요. 시작하려면 이것만 하면 됩니다.",
  "providers.setup.done": "공급자가 준비되었습니다. ‘앱으로 돌아가기’로 돌아가면 초안이 그대로 있습니다.",
  ...
  "startup.failed.body": "창이 준비되기 전에 문제가 발생했습니다. 다시 시도하거나 진단 정보를 복사해 보고하세요.",
  "startup.failed.copy": "진단 정보 복사",
  "startup.failed.copied": "복사됨",
  "plugins.renderFailed.details": "세부 정보",
  "settings.notifications": "시스템 알림",
  "settings.notifications.permission.granted": "Flame이 백그라운드에 있을 때 실행이 끝나거나 실패하거나 입력이 필요하면 알립니다.",
  "settings.notifications.permission.default": "처음 알릴 일이 생길 때 권한을 요청합니다.",
  "settings.notifications.permission.denied": "시스템에서 차단되었습니다. 시스템 설정 › 알림에서 Flame을 허용하세요.",
