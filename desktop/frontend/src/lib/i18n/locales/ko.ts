...
export const ko: Record<string, string> = {
  ...
  "tool.label.shell": "셸",
  "tool.label.generic": "도구",
  "tool.label.readShellOutput": "출력 읽기",
  "tool.label.stopShell": "명령 중지",
  "tool.label.webSearch": "웹 검색",
  "tool.label.webFetch": "페이지 가져오기",
  "tool.label.httpRequest": "HTTP 요청",
  "tool.label.loadSkill": "스킬 로드",
  "tool.label.readSkillResource": "스킬 파일",
  "tool.label.proposeSkill": "스킬 제안",
  "tool.label.delegateTask": "위임",
  "tool.label.askUser": "질문",
  "tool.label.searchMemory": "기억 검색",
  "tool.label.searchConversations": "대화 검색",
  "tool.label.searchTools": "도구 검색",
  "tool.label.createSchedule": "일정 생성",
  "tool.label.deleteSchedule": "일정 삭제",
  "tool.label.createGoal": "목표 설정",
  "tool.label.getGoal": "목표 읽기",
  "tool.label.reportGoalOutcome": "목표 보고",
  "tool.label.read": "읽기",
  "tool.label.edit": "편집",
  "tool.label.write": "쓰기",
