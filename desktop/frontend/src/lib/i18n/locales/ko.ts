export const ko: Record<string, string> = {
  ...
  "composer.model.inputModalities": "입력 {{modalities}}",
  "composer.model.outputModalities": "출력 {{modalities}}",
  "composer.model.reasoning": "추론 지원",
  "composer.model.reasoningLevels": "추론 단계 {{levels}}",
  "composer.model.toolUse": "도구",
  "composer.model.structuredOutput": "구조화된 출력",
  "composer.model.knowledgeCutoff": "지식 기준일 {{cutoff}}",
  ...
  "tools.http.headers_other": "헤더 {{count}}개",
  "inbox.title": "받은 항목",
  ...
  "goal.mode.clear": "Goal 모드 종료",
  "goal.action.pause": "목표 일시 중지",
  "goal.action.resume": "목표 재개",
  "goal.action.clear": "목표 지우기",
  "goal.action.edit": "목표 편집",
  "goal.edit.title": "목표 편집",
  "goal.edit.label": "목표",
  "goal.edit.save": "저장",
  "goal.edit.saving": "저장 중…",
  "goal.error.start": "목표를 시작할 수 없습니다",
  "goal.error.attachmentsUnsupported": "Goal 목표에는 첨부 파일을 포함할 수 없습니다",
  "goal.error.pause": "목표를 일시 중지할 수 없습니다",
  "goal.error.resume": "목표를 계속할 수 없습니다",
  "goal.error.clear": "목표를 지울 수 없습니다",
  "goal.error.update": "목표를 업데이트할 수 없습니다",
  ...
  "goal.replace.body": '"{{objective}}"은(는) 여기서 끝납니다. 대화는 그대로 남습니다.',
  "goal.replace.confirm": "목표 교체",
  "tools.grep.matchCount_other": "{{count}}건",
  "tools.overflow.matches_other": "일치 항목 {{count}}개 더",
  "tools.output.label": "도구 출력",
  "tools.output.copy": "출력 복사",
  "tools.output.copied": "복사됨",
  "tools.output.collapse": "접기",
  "tools.overflow.truncated": "런타임에서 잘렸습니다",
  "tools.group.calls_other": "호출 {{count}}회",
  "common.remove": "제거",
  ...
  "status.notifications.unread_other": "읽지 않은 알림 {{count}}건",
  ...
  "settings.font.ui": "인터페이스 글꼴",
  "settings.font.ui.sub": "레이블, 메뉴, 버튼에 쓰이는 글꼴.",
  "settings.font.code": "코드 글꼴",
  "settings.font.code.sub": "diff, 터미널, 코드 블록에 쓰이는 글꼴.",
  "settings.font.size": "인터페이스 크기",
  "settings.font.size.sub": "앱 전체의 기준 글자 크기.",
  "settings.font.smoothing": "글꼴 부드럽게",
  "settings.font.smoothing.sub": "macOS 앤티앨리어싱. 획이 얇아지고 가장자리가 부드러워집니다.",
  ...
  "runtime.connection.unavailable": "Runtime을 사용할 수 없습니다. Flame가 계속 다시 연결합니다.",
  ...
  "question.settled.question_other": "질문 {{count}}개",
  ...
  "timeline.latestCalls": "최신 호출",
  "timeline.olderCalls": "이전 호출",
  "timeline.modelCall.started": "호출 중",
  "timeline.modelCall.completed": "완료",
  "timeline.modelCall.failed": "실패",
  "timeline.modelCall.unknown": "결과 알 수 없음",
  "timeline.recentWindow": "최근 기록 {{count}}개 표시",
  "timeline.kind.compaction": "컨텍스트 압축됨",
  "timeline.executionDuration": "실행 시간 (승인 대기 제외)",
  ...
  "search.aria": "검색 패턴",
  "search.scope": "세션 워크스페이스에서 정규식 검색",
  "search.prompt.title": "이 워크스페이스 검색",
  "search.matches_other": "일치 항목 {{count}}개",
  "search.overflow_other": "표시되지 않은 일치 항목 {{count}}개 — 검색 범위를 좁히세요.",
  ...
  "skills.title": "스킬",
  "skills.tab.available": "사용 가능",
  "skills.tab.review": "검토",
  "skills.tab.library": "개인",
  ...
  "knowledge.empty.sub": "런타임이 agent를 위해 유지 관리하는 FLAME.md 파일이 여기에 표시됩니다.",
  ...
  "diff.fileCount_other": "파일 {{count}}개",
  ...
  "announce.running": "응답 중",
  "announce.needsInput": "답변을 기다리는 중",
  "announce.finished": "응답 완료",
  "announce.error": "턴이 실패했습니다.",
  "announce.canceled": "턴이 중지되었습니다",
  ...
  "composer.paste.chars_other": "붙여넣기 · {{count}}자",
  ...
  "settings.appearance.hero": "테마, 대비, 타이포그래피, 모션이 Flame의 사용감을 결정합니다.",
  ...
  "usage.reasoning": "추론",
  "usage.sessions_other": "{{count}}개 세션",
  "usage.runs_other": "{{count}}회 실행",
  ...
  "hooks.intro":
    "훅은 턴 안의 정해진 시점에 사용자의 명령을 실행합니다 — 도구 실행 전, 프롬프트 후, 압축 시. 전역 훅(~/.flame)은 항상 실행되며, 프로젝트 훅은 신뢰한 뒤에만 실행됩니다.",
  ...
  "hooks.empty.sub":
    "~/.flame/hooks.json(전역) 또는 <project>/.flame/hooks.json에 훅을 추가하세요.",
  ...
  "mcp.import.ok_other": "서버 {{count}}개를 가져왔습니다",
  ...
  "rpcError.denied_by_user": "이 작업을 거부했습니다.",
  ...
  "rpcError.mcp_server_not_found": "해당 서버가 설정에 없습니다.",
  "rpcError.mcp_server_already_exists": "같은 이름의 서버가 이미 설정되어 있습니다.",
  "rpcError.mcp_server_disabled": "해당 서버가 꺼져 있습니다. 먼저 켜세요.",
  "rpcError.schedule_not_found": "해당 일정이 더 이상 없습니다.",
  "rpcError.path_outside_root": "해당 경로는 세션 작업 디렉터리 밖입니다.",
  ...
  "composer.error.readImages_other": "이미지 {{count}}장을 읽을 수 없습니다",
  "tool.action.generic": "도구 호출",
  "tool.action.shell": "명령 실행",
  "tool.action.readShellOutput": "출력 읽기",
  "tool.action.stopShell": "명령 중지",
  "tool.action.read": "파일 읽기",
  "tool.action.applyPatch": "패치 적용",
  "tool.action.grep": "텍스트 검색",
  "tool.action.glob": "파일 찾기",
  "tool.action.lsp": "코드 검사",
  "tool.action.webSearch": "웹 검색",
  "tool.action.webFetch": "페이지 가져오기",
  "tool.action.httpRequest": "요청 보내기",
  "tool.action.listSkills": "스킬 목록 보기",
  "tool.action.loadSkill": "스킬 불러오기",
  "tool.action.readSkillResource": "스킬 파일 읽기",
  "tool.action.proposeSkill": "스킬 제안",
  "tool.action.delegateTask": "작업 위임",
  "tool.action.askUser": "사용자에게 질문",
  "tool.action.enterPlanMode": "계획 모드 진입",
  "tool.action.setPlan": "계획 업데이트",
  "tool.action.exitPlanMode": "계획 승인 요청",
  "tool.action.searchMemory": "메모리 검색",
  "tool.action.searchConversations": "대화 검색",
  "tool.action.searchTools": "도구 찾기",
  "tool.action.readToolResult": "저장된 출력 읽기",
  "tool.action.listSchedules": "예약 목록 보기",
  "tool.action.createSchedule": "예약 만들기",
  "tool.action.deleteSchedule": "예약 삭제",
  "tool.action.createGoal": "목표 만들기",
  "tool.action.getGoal": "목표 읽기",
  "tool.action.reportGoalOutcome": "목표 결과 보고",
  "tool.doing.generic": "도구 사용 중",
  "tool.done.generic": "도구 사용",
  "tool.doing.shell": "실행 중",
  "tool.done.shell": "실행",
  "tool.doing.readShellOutput": "출력 읽는 중",
  "tool.done.readShellOutput": "출력 읽음",
  "tool.doing.stopShell": "명령 중지 중",
  "tool.done.stopShell": "명령 중지",
  "tool.doing.read": "읽는 중",
  "tool.done.read": "읽음",
  "tool.doing.applyPatch": "패치 적용 중",
  "tool.done.applyPatch": "패치 적용",
  "tool.doing.grep": "검색 중",
  "tool.done.grep": "검색함",
  "tool.doing.glob": "파일 찾는 중",
  "tool.done.glob": "파일 찾음",
  "tool.doing.lsp": "코드 분석 중",
  "tool.done.lsp": "코드 분석",
  "tool.doing.webSearch": "웹 검색 중",
  "tool.done.webSearch": "웹 검색함",
  "tool.doing.webFetch": "페이지 가져오는 중",
  "tool.done.webFetch": "페이지 가져옴",
  "tool.doing.httpRequest": "요청 중",
  "tool.done.httpRequest": "요청함",
  "tool.doing.listSkills": "스킬 목록 조회 중",
  "tool.done.listSkills": "스킬 목록 조회",
  "tool.doing.loadSkill": "스킬 로드 중",
  "tool.done.loadSkill": "스킬 로드",
  "tool.doing.readSkillResource": "스킬 파일 읽는 중",
  "tool.done.readSkillResource": "스킬 파일 읽음",
  "tool.doing.proposeSkill": "스킬 제안 중",
  "tool.done.proposeSkill": "스킬 제안",
  "tool.doing.delegateTask": "위임 중",
  "tool.done.delegateTask": "위임함",
  "tool.doing.askUser": "질문 중",
  "tool.done.askUser": "질문함",
  "tool.doing.enterPlanMode": "플랜 모드 진입 중",
  "tool.done.enterPlanMode": "플랜 모드 진입",
  "tool.doing.setPlan": "플랜 업데이트 중",
  "tool.done.setPlan": "플랜 업데이트",
  "tool.doing.exitPlanMode": "플랜 승인 요청 중",
  "tool.done.exitPlanMode": "플랜 승인 요청",
  "tool.doing.searchMemory": "기억 검색 중",
  "tool.done.searchMemory": "기억 검색",
  "tool.doing.searchConversations": "대화 검색 중",
  "tool.done.searchConversations": "대화 검색",
  "tool.doing.searchTools": "도구 찾는 중",
  "tool.done.searchTools": "도구 찾음",
  "tool.doing.readToolResult": "저장된 출력 읽는 중",
  "tool.done.readToolResult": "저장된 출력 읽음",
  "tool.doing.listSchedules": "일정 목록 조회 중",
  "tool.done.listSchedules": "일정 목록 조회",
  "tool.doing.createSchedule": "일정 생성 중",
  "tool.done.createSchedule": "일정 생성",
  "tool.doing.deleteSchedule": "일정 삭제 중",
  "tool.done.deleteSchedule": "일정 삭제",
  "tool.doing.createGoal": "목표 설정 중",
  "tool.done.createGoal": "목표 설정",
  "tool.doing.getGoal": "목표 읽는 중",
  "tool.done.getGoal": "목표 읽음",
  ...
  "composer.image.preview": "이미지 보기",
  "composer.paste.review": "붙여넣은 텍스트 검토",
  ...
  "composer.mention.status.no-workspace": "파일을 참조하려면 프로젝트를 선택하세요",
  "providers.apiKey.label": "API 키",
  "providers.baseUrl.label": "기본 URL",
  "providers.baseUrl.labelRequired": "기본 URL · 필수",
  "providers.baseUrl.required": "이 공급자를 저장하려면 기본 URL이 필요합니다.",
  "providers.saveAndTest": "저장 후 테스트",
  "providers.saved": "저장됨",
  "providers.role.loadError": "이 설정을 불러올 수 없어 현재 값을 알 수 없습니다.",
  "providers.role.stale": "마지막으로 확인된 값을 표시 중입니다 — 새로 고침에 실패했습니다.",
  "providers.setup.steps":
    "공급자 하나를 고르고 API 키를 붙여넣은 뒤 ‘저장 후 테스트’를 누르세요. 시작하려면 이것만 하면 됩니다.",
  "providers.setup.done":
    "공급자가 준비되었습니다. ‘앱으로 돌아가기’로 돌아가면 초안이 그대로 있습니다.",
  "providers.roles.heading": "모델 역할",
  "settings.search.empty": "“{{query}}”와(과) 일치하는 설정이 없습니다.",
  "settings.search.clear": "검색 지우기",
  "startup.failed.title": "Flame을 시작할 수 없습니다",
  "startup.failed.body":
    "창이 준비되기 전에 문제가 발생했습니다. 다시 시도하거나 진단 정보를 복사해 보고하세요.",
  "startup.failed.copy": "진단 정보 복사",
  ...
  "notify.needsInput.body": "에이전트가 승인이나 답변을 기다리고 있습니다.",
  "notify.error.title": "{{product}} 오류 발생",
  "notify.error.body": "에이전트 실행에 실패했습니다.",
  "notify.canceled.title": "{{product}} 중지됨",
  "notify.canceled.body": "에이전트 실행이 취소되었습니다.",
  "tools.read.notRecorded":
    "이 읽기 결과는 기록되지 않았습니다. 현재 파일을 열어 지금 내용을 확인하세요.",
  "tool.open.currentFile": "현재 파일 열기",
  "tool.open.worktreeDiff": "작업 트리 변경 사항 열기",
  "tools.overflow.lines_other": "{{count}}줄 더",
  "tools.output.earlier_other": "이전 {{count}}줄 보기 · 전체 {{total}}줄",
  "tools.output.latest": "최신으로 이동",
  "message.user.unfold": "전체 메시지 보기",
  "message.user.fold": "접기",
  "composer.steer.hint": "보내면 지금 실행 중인 작업에 추가됩니다.",
  "message.mermaid.fit": "맞춤",
  "message.mermaid.zoomIn": "다이어그램 확대",
  "message.mermaid.zoomOut": "다이어그램 축소",
  "file.range": "전체 {{total}}줄 중 {{start}}–{{end}}줄",
  "file.copyPath": "경로 복사",
  "file.reveal": "Finder에서 보기",
  "file.goToLine": "줄로 이동",
  "file.goToLine.placeholder": "줄 번호",
  "file.mode": "파일 보기",
  "file.mode.rendered": "미리보기",
  "file.mode.source": "소스",
  "file.loadEarlier_other": "이전 {{count}}줄 보기",
  "file.loadLater_other": "{{count}}줄 더 보기",
  "quote.selection": "메시지에 인용",
  "diff.worktree.open_other": "작업 트리에서 변경된 파일 {{count}}개 검토",
  "diff.status.added": "추가됨",
  "diff.status.modified": "수정됨",
  "diff.status.deleted": "삭제됨",
  "diff.status.renamed": "이름 변경",
  "diff.status.untracked": "추적 안 됨",
  "diff.nav.picker": "파일로 이동",
  "diff.nav.filter": "변경된 파일 필터",
  "diff.nav.none": "일치하는 변경 파일 없음",
  "diff.nav.previous": "이전 파일",
  "diff.nav.next": "다음 파일",
  "diff.nav.collapseAll": "모든 파일 접기",
  "diff.nav.expandAll": "모든 파일 펼치기",
  "search.scope.placeholder": "폴더 또는 파일, 예: src/",
  "search.scope.aria": "검색 범위",
  "search.narrow": "폴더로 좁히기",
