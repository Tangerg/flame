export const ko: Record<string, string> = {
  ...
  "goal.stopped.runBudget": "실행 한도에 도달함",
  "goal.stopped.costBudget": "비용 한도에 도달함",
  "goal.stopped.stepBudget": "스텝 한도에 도달함",
  "goal.stopped.pricingUnavailable": "모델 가격 정보 없음",
