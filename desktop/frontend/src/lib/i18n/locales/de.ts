export const de: Record<string, string> = {
  "recipes.error.load": "Rezepte konnten nicht geladen werden.",
  ...
  "composer.model.title": "Modelle",
  "composer.model.recent": "Zuletzt verwendet",
  ...
  "composer.model.inputModalities": "Eingabe: {{modalities}}",
  "composer.model.outputModalities": "Ausgabe: {{modalities}}",
  "composer.model.reasoning": "Denkmodus",
  "composer.model.reasoningLevels": "Denkstufen: {{levels}}",
  "composer.model.toolUse": "Werkzeuge",
  "composer.model.structuredOutput": "Strukturierte Ausgabe",
  "composer.model.knowledgeCutoff": "Wissensstand: {{cutoff}}",
  ...
  "tools.http.headers_other": "{{count}} Header",
  "inbox.title": "Eingang",
  ...
  "goal.mode.clear": "Goal-Modus verlassen",
  "goal.action.pause": "Ziel pausieren",
  "goal.action.resume": "Ziel fortsetzen",
  "goal.action.clear": "Ziel löschen",
  "goal.action.edit": "Ziel bearbeiten",
  "goal.edit.title": "Ziel bearbeiten",
  "goal.edit.label": "Ziel",
  "goal.edit.save": "Speichern",
  "goal.edit.saving": "Wird gespeichert…",
  "goal.error.start": "Das Ziel konnte nicht gestartet werden",
  "goal.error.attachmentsUnsupported": "Goal-Ziele können keine Anhänge enthalten",
  "goal.error.pause": "Das Ziel konnte nicht pausiert werden",
  "goal.error.resume": "Das Ziel konnte nicht fortgesetzt werden",
  "goal.error.clear": "Das Ziel konnte nicht gelöscht werden",
  "goal.error.update": "Das Ziel konnte nicht aktualisiert werden",
  ...
  "goal.replace.body": "„{{objective}}“ endet hier. Die Unterhaltung bleibt erhalten.",
  "goal.replace.confirm": "Ziel ersetzen",
  "tools.grep.matchCount_one": "{{count}} Treffer",
  "tools.grep.matchCount_other": "{{count}} Treffer",
  "tools.overflow.matches_one": "{{count}} weiterer Treffer",
  "tools.overflow.matches_other": "{{count}} weitere Treffer",
  "tools.output.label": "Werkzeugausgabe",
  ...
  "tools.group.calls_one": "{{count}} Aufruf",
  "tools.group.calls_other": "{{count}} Aufrufe",
  ...
  "status.notifications.unread_one": "{{count}} ungelesene Benachrichtigung",
  "status.notifications.unread_other": "{{count}} ungelesene Benachrichtigungen",
  ...
  "plugins.errors_other": "{{count}} Fehler",
  ...
  "settings.font.ui": "Oberflächenschrift",
  "settings.font.ui.sub": "Schriftart für Beschriftungen, Menüs und Schaltflächen.",
  "settings.font.code": "Codeschrift",
  "settings.font.code.sub": "Schriftart für Diffs, Terminals und Codeblöcke.",
  "settings.font.size": "Schriftgröße",
  "settings.font.size.sub": "Basisgröße für Text in der gesamten App.",
  "settings.font.smoothing": "Kantenglättung",
  "settings.font.smoothing.sub": "macOS-Antialiasing. Dünnere Striche, weichere Kanten.",
  ...
  "settings.connection.sub": "Adresse der Flame Runtime. Anwenden verbindet die Desktop-App neu.",
  ...
  "runtime.connection.unavailable":
    "Die Runtime ist nicht verfügbar. Flame versucht weiterhin, die Verbindung herzustellen.",
  ...
  "question.settled.question_one": "{{count}} Frage",
  "question.settled.question_other": "{{count}} Fragen",
  ...
  "session.identity.copyCwd": "Arbeitsverzeichnis kopieren",

  "session.identity.copiedCwd": "Arbeitsverzeichnis kopiert",

  "session.identity.copyId": "Sitzungs-ID kopieren",

  "session.identity.copiedId": "Sitzungs-ID kopiert",
  "session.status.waiting": "Wartet auf Eingabe",

  "agent.runTree.delegated.one": "Subagent",
  "subagents.title": "Subagenten",
  "subagents.active": "Aktiv",
  "subagents.completed": "Abgeschlossen",
  "subagents.count_one": "{{count}} Subagent",
  "subagents.count_other": "{{count}} Subagenten",
  "subagents.running_one": "{{count}} aktiv",
  "subagents.running_other": "{{count}} aktiv",
  "subagents.empty": "Noch keine Subagenten",
  "subagents.unavailable": "Dieser Subagent ist nicht mehr verfügbar",
  ...
  "timeline.summary.runs_one": "{{count}} Lauf",
  ...
  "timeline.latestCalls": "Neueste Aufrufe",
  "timeline.olderCalls": "Ältere Aufrufe",
  "timeline.modelCall.started": "Aufruf läuft",
  "timeline.modelCall.completed": "Abgeschlossen",
  "timeline.modelCall.failed": "Fehlgeschlagen",
  "timeline.modelCall.unknown": "Ergebnis unbekannt",
  ...
  "search.scope": "Regex über den Session-Workspace",
  "search.prompt.title": "Diesen Workspace durchsuchen",
  "search.matches_one": "{{count}} Treffer",
  "search.matches_other": "{{count}} Treffer",
  "search.overflow_one": "{{count}} weiterer Treffer wird nicht gezeigt — Suche eingrenzen.",
  "search.overflow_other": "{{count}} weitere Treffer werden nicht gezeigt — Suche eingrenzen.",
  ...
  "skills.title": "Skills",
  "skills.tab.available": "Verfügbar",
  ...
  "diff.fileCount_one": "{{count}} Datei",
  "diff.fileCount_other": "{{count}} Dateien",
  ...
  "announce.running": "Antwortet",
  "announce.needsInput": "Wartet auf deine Antwort",
  "announce.finished": "Antwort abgeschlossen",
  "announce.error": "Der Durchlauf ist fehlgeschlagen.",
  "announce.canceled": "Der Durchlauf wurde gestoppt",
  ...
  "reasoning.thoughtFor": "{{duration}} nachgedacht",
  ...
  "composer.paste.lines_other": "Eingefügt · {{count}} Zeilen",
  "composer.paste.chars_one": "Eingefügt · {{count}} Zeichen",
  "composer.paste.chars_other": "Eingefügt · {{count}} Zeichen",
  ...
  "settings.appearance.hero":
    "Themes, Kontrast, Typografie und Bewegung bestimmen das Arbeitsgefühl von Flame.",
  ...
  "usage.total": "Gesamt",
  "usage.cache": "Cache-Lesen",
  "usage.cacheWrite": "Cache-Schreiben",
  "usage.reasoning": "Reasoning",
  "usage.sessions_one": "{{count}} Sitzung",
  "usage.sessions_other": "{{count}} Sitzungen",
  "usage.runs_one": "{{count}} Lauf",
  "usage.runs_other": "{{count}} Läufe",
  ...
  "hooks.intro":
    "Hooks führen deine eigenen Befehle an festen Punkten eines Zugs aus — vor einem Tool, nach einem Prompt, bei der Verdichtung. Globale Hooks (~/.flame) laufen immer; die Hooks eines Projekts erst, wenn du ihm vertraust.",
  ...
  "hooks.empty.sub":
    "Füge Hooks in ~/.flame/hooks.json (global) oder <project>/.flame/hooks.json hinzu.",
  ...
  "mcp.import.ok_one": "{{count}} Server importiert",
  "mcp.import.ok_other": "{{count}} Server importiert",
  "mcp.import.renamed": "Umbenannt, damit die Runtime sie akzeptiert: {{names}}",
  ...
  "composer.error.readImages_one": "{{count}} Bild konnte nicht gelesen werden",
  "composer.error.readImages_other": "{{count}} Bilder konnten nicht gelesen werden",
  "tool.action.generic": "Werkzeugaufruf",
  "tool.action.shell": "Befehl ausführen",
  "tool.action.readShellOutput": "Ausgabe lesen",
  "tool.action.stopShell": "Befehl stoppen",
  "tool.action.read": "Datei lesen",
  "tool.action.applyPatch": "Patch anwenden",
  "tool.action.grep": "Text suchen",
  "tool.action.glob": "Dateien finden",
  "tool.action.lsp": "Code untersuchen",
  "tool.action.webSearch": "Web durchsuchen",
  "tool.action.webFetch": "Seite abrufen",
  "tool.action.httpRequest": "Anfrage senden",
  "tool.action.listSkills": "Skills auflisten",
  "tool.action.loadSkill": "Skill laden",
  "tool.action.readSkillResource": "Skill-Datei lesen",
  "tool.action.proposeSkill": "Skill vorschlagen",
  "tool.action.delegateTask": "Aufgabe delegieren",
  "tool.action.askUser": "Benutzer fragen",
  "tool.action.enterPlanMode": "Planmodus starten",
  "tool.action.setPlan": "Plan aktualisieren",
  "tool.action.exitPlanMode": "Planfreigabe anfordern",
  "tool.action.searchMemory": "Erinnerungen durchsuchen",
  "tool.action.searchConversations": "Unterhaltungen durchsuchen",
  "tool.action.searchTools": "Werkzeuge finden",
  "tool.action.readToolResult": "Gespeicherte Ausgabe lesen",
  "tool.action.listSchedules": "Zeitpläne auflisten",
  "tool.action.createSchedule": "Zeitplan erstellen",
  "tool.action.deleteSchedule": "Zeitplan löschen",
  "tool.action.createGoal": "Ziel erstellen",
  "tool.action.getGoal": "Ziel lesen",
  "tool.action.reportGoalOutcome": "Zielergebnis melden",
  "tool.doing.generic": "Verwendet Werkzeug",
  "tool.done.generic": "Werkzeug verwendet",
  "tool.doing.shell": "Führt aus",
  "tool.done.shell": "Ausgeführt",
  "tool.doing.readShellOutput": "Liest Ausgabe",
  "tool.done.readShellOutput": "Ausgabe gelesen",
  "tool.doing.stopShell": "Stoppt Befehl",
  "tool.done.stopShell": "Befehl gestoppt",
  "tool.doing.read": "Liest",
  "tool.done.read": "Gelesen",
  "tool.doing.applyPatch": "Wendet Patch an",
  "tool.done.applyPatch": "Patch angewendet",
  "tool.doing.grep": "Sucht",
  "tool.done.grep": "Gesucht",
  "tool.doing.glob": "Sucht Dateien",
  "tool.done.glob": "Dateien gefunden",
  "tool.doing.lsp": "Analysiert",
  "tool.done.lsp": "Analysiert",
  "tool.doing.webSearch": "Durchsucht das Web",
  "tool.done.webSearch": "Web durchsucht",
  "tool.doing.webFetch": "Ruft Seite ab",
  "tool.done.webFetch": "Seite abgerufen",
  "tool.doing.httpRequest": "Sendet Anfrage",
  "tool.done.httpRequest": "Anfrage gesendet",
  "tool.doing.listSkills": "Listet Skills auf",
  "tool.done.listSkills": "Skills aufgelistet",
  "tool.doing.loadSkill": "Lädt Skill",
  "tool.done.loadSkill": "Skill geladen",
  "tool.doing.readSkillResource": "Liest Skill-Datei",
  "tool.done.readSkillResource": "Skill-Datei gelesen",
  "tool.doing.proposeSkill": "Schlägt Skill vor",
  "tool.done.proposeSkill": "Skill vorgeschlagen",
  "tool.doing.delegateTask": "Delegiert",
  "tool.done.delegateTask": "Delegiert",
  "tool.doing.askUser": "Fragt nach",
  "tool.done.askUser": "Nachgefragt",
  "tool.doing.enterPlanMode": "Wechselt in Planungsmodus",
  "tool.done.enterPlanMode": "Planungsmodus betreten",
  "tool.doing.setPlan": "Aktualisiert den Plan",
  "tool.done.setPlan": "Plan aktualisiert",
  "tool.doing.exitPlanMode": "Fordert Planfreigabe an",
  "tool.done.exitPlanMode": "Planfreigabe angefordert",
  "tool.doing.searchMemory": "Durchsucht Erinnerung",
  "tool.done.searchMemory": "Erinnerung durchsucht",
  "tool.doing.searchConversations": "Durchsucht Verlauf",
  "tool.done.searchConversations": "Verlauf durchsucht",
  "tool.doing.searchTools": "Sucht Werkzeuge",
  "tool.done.searchTools": "Werkzeuge gefunden",
  "tool.doing.readToolResult": "Liest gespeicherte Ausgabe",
  "tool.done.readToolResult": "Gespeicherte Ausgabe gelesen",
  "tool.doing.listSchedules": "Listet Planungen auf",
  "tool.done.listSchedules": "Planungen aufgelistet",
  "tool.doing.createSchedule": "Plant",
  "tool.done.createSchedule": "Geplant",
  "tool.doing.deleteSchedule": "Löscht Planung",
  "tool.done.deleteSchedule": "Planung gelöscht",
  "tool.doing.createGoal": "Setzt Ziel",
  "tool.done.createGoal": "Ziel gesetzt",
  "tool.doing.getGoal": "Liest Ziel",
  "tool.done.getGoal": "Ziel gelesen",
  "tool.doing.reportGoalOutcome": "Meldet Ziel",
  ...
  "tool.meta.files_other": "{{count}} Dateien",
  "tool.meta.exit": "Exit {{code}}",
  "tool.state.denied": "abgelehnt",
  "tool.state.failed": "fehlgeschlagen",
  ...
  "duration.hours": "{{hr}} Std. {{min}} min",
  "composer.image.preview": "Bild ansehen",
  "composer.paste.review": "Eingefügten Text prüfen",
  ...
  "composer.mention.status.no-workspace": "Wähle ein Projekt, um seine Dateien zu referenzieren",
  "providers.apiKey.label": "API-Schlüssel",
  "providers.baseUrl.label": "Basis-URL",
  "providers.baseUrl.labelRequired": "Basis-URL · erforderlich",
  "providers.baseUrl.required":
    "Dieser Anbieter braucht eine Basis-URL, bevor er gespeichert werden kann.",
  "providers.saveAndTest": "Speichern & testen",
  "providers.saved": "Gespeichert",
  "providers.role.loadError":
    "Diese Einstellung konnte nicht geladen werden, ihr aktueller Wert ist unbekannt.",
  "providers.role.stale":
    "Zeigt den zuletzt bekannten Wert – die Aktualisierung ist fehlgeschlagen.",
  "providers.setup.steps":
    "Wähle einen Anbieter, füge seinen API-Schlüssel ein und klicke auf „Speichern & testen“. Mehr brauchst du zum Starten nicht.",
  "providers.setup.done":
    "Ein Anbieter ist bereit. Mit „Zurück zur App“ kehrst du zurück – dein Entwurf ist noch da.",
  "providers.roles.heading": "Modellrollen",
  "settings.search.empty": "Keine Einstellung passt zu „{{query}}“.",
  "settings.search.clear": "Suche löschen",
  "startup.failed.title": "Flame konnte nicht starten",
  "startup.failed.body":
    "Vor dem Bereitstellen des Fensters ist etwas fehlgeschlagen. Versuche es erneut oder kopiere die Diagnose, um es zu melden.",
  "startup.failed.copy": "Diagnose kopieren",
  ...
  "notify.needsInput.title": "{{product}} braucht dich",
  "notify.needsInput.body": "Der Agent wartet auf deine Freigabe oder Antwort.",
  "notify.error.title": "{{product}} hat einen Fehler",
  "notify.error.body": "Der Agentenlauf ist fehlgeschlagen.",
  "notify.canceled.title": "{{product}} wurde gestoppt",
  "notify.canceled.body": "Der Agentenlauf wurde abgebrochen.",
  "tools.read.notRecorded":
    "Was dieses Lesen zurückgab, wurde nicht aufgezeichnet. Öffne die aktuelle Datei, um sie jetzt zu sehen.",
  "tool.open.currentFile": "Aktuelle Datei öffnen",
  "tool.open.worktreeDiff": "Arbeitsbaum-Diff öffnen",
  "tools.overflow.lines_one": "{{count}} weitere Zeile",
  "tools.overflow.lines_other": "{{count}} weitere Zeilen",
  "tools.output.earlier_one": "{{count}} frühere Zeile zeigen · {{total}} insgesamt",
  "tools.output.earlier_other": "{{count}} frühere Zeilen zeigen · {{total}} insgesamt",
  "tools.output.latest": "Zum Neuesten",
  "message.user.unfold": "Ganze Nachricht zeigen",
  "message.user.fold": "Weniger zeigen",
  "composer.steer.hint": "Senden fügt dies der laufenden Aufgabe hinzu.",
  "message.mermaid.fit": "Einpassen",
  "message.mermaid.zoomIn": "Diagramm vergrößern",
  "message.mermaid.zoomOut": "Diagramm verkleinern",
  "file.range": "Zeilen {{start}}–{{end}} von {{total}}",
  "file.copyPath": "Pfad kopieren",
  "file.reveal": "Im Finder zeigen",
  "file.goToLine": "Gehe zu Zeile",
  "file.goToLine.placeholder": "Zeilennummer",
  "file.mode": "Dateiansicht",
  "file.mode.rendered": "Vorschau",
  "file.mode.source": "Quelltext",
  "file.loadEarlier_one": "{{count}} frühere Zeile zeigen",
  "file.loadEarlier_other": "{{count}} frühere Zeilen zeigen",
  "file.loadLater_one": "{{count}} weitere Zeile zeigen",
  "file.loadLater_other": "{{count}} weitere Zeilen zeigen",
  "quote.selection": "In Nachricht zitieren",
  "diff.worktree.open_one": "{{count}} geänderte Datei im Arbeitsbaum prüfen",
  "diff.worktree.open_other": "{{count}} geänderte Dateien im Arbeitsbaum prüfen",
  "diff.status.added": "Hinzugefügt",
  "diff.status.modified": "Geändert",
  "diff.status.deleted": "Gelöscht",
  "diff.status.renamed": "Umbenannt",
  "diff.status.untracked": "Nicht verfolgt",
  "diff.nav.picker": "Zu Datei",
  "diff.nav.filter": "Geänderte Dateien filtern",
  "diff.nav.none": "Keine geänderte Datei passt",
  "diff.nav.previous": "Vorherige Datei",
  "diff.nav.next": "Nächste Datei",
  "diff.nav.collapseAll": "Alle Dateien einklappen",
  "diff.nav.expandAll": "Alle Dateien ausklappen",
  "search.scope.placeholder": "Ordner oder Datei, z. B. src/",
  "search.scope.aria": "Suchen in",
  "search.narrow": "Auf einen Ordner eingrenzen",
  "session.row.more": "Weitere Aktionen für {{title}}",
