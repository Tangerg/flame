...
export const de: Record<string, string> = {
  ...
  "tool.label.generic": "Werkzeug",
  "tool.label.readShellOutput": "Ausgabe lesen",
  "tool.label.stopShell": "Befehl stoppen",
  "tool.label.webSearch": "Websuche",
  "tool.label.webFetch": "Seite abrufen",
  "tool.label.httpRequest": "HTTP-Anfrage",
  "tool.label.loadSkill": "Skill laden",
  "tool.label.readSkillResource": "Skill-Datei",
  "tool.label.proposeSkill": "Skill vorschlagen",
  "tool.label.delegateTask": "Delegieren",
  "tool.label.askUser": "Nachfragen",
  "tool.label.searchMemory": "Erinnerung suchen",
  "tool.label.searchConversations": "Verlauf suchen",
  "tool.label.searchTools": "Werkzeug suchen",
  "tool.label.createSchedule": "Planen",
  "tool.label.deleteSchedule": "Planung löschen",
  "tool.label.createGoal": "Ziel setzen",
  "tool.label.getGoal": "Ziel lesen",
  "tool.label.reportGoalOutcome": "Ziel melden",
