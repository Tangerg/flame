export const de: Record<string, string> = {
  ...
  "providers.baseUrl.required": "Dieser Anbieter braucht eine Basis-URL, bevor er gespeichert werden kann.",
  "providers.saveAndTest": "Speichern & testen",
  "providers.saved": "Gespeichert",
  "providers.role.loadError": "Diese Einstellung konnte nicht geladen werden, ihr aktueller Wert ist unbekannt.",
  "providers.role.stale": "Zeigt den zuletzt bekannten Wert – die Aktualisierung ist fehlgeschlagen.",
  "providers.setup.steps": "Wähle einen Anbieter, füge seinen API-Schlüssel ein und klicke auf „Speichern & testen“. Mehr brauchst du zum Starten nicht.",
  "providers.setup.done": "Ein Anbieter ist bereit. Mit „Zurück zur App“ kehrst du zurück – dein Entwurf ist noch da.",
  ...
  "startup.failed.body": "Vor dem Bereitstellen des Fensters ist etwas fehlgeschlagen. Versuche es erneut oder kopiere die Diagnose, um es zu melden.",
  ...
  "settings.notifications.permission.granted": "Erscheinen, wenn ein Lauf endet, fehlschlägt oder dich braucht, während Flame im Hintergrund ist.",
  "settings.notifications.permission.default": "Flame fragt beim ersten Mal nach der Berechtigung.",
  "settings.notifications.permission.denied": "Vom System blockiert. Erlaube Flame unter Systemeinstellungen › Mitteilungen.",
  "settings.notifications.permission.unsupported": "Diese Plattform bietet keine Systembenachrichtigungen.",
