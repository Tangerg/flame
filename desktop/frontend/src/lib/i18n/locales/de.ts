...
export const de: Record<string, string> = {
  ...
  "tools.output.beyond_one": "{{count}} weitere Zeile — in der Terminalansicht öffnen",
  "tools.output.beyond_other": "{{count}} weitere Zeilen — in der Terminalansicht öffnen",
  ...
  "files.uncommitted_other": "{{count}} Dateien · nicht committet",
  "files.binary": "bin",
