...
export const zh: Record<string, string> = {
  ...
  "tool.label.shell": "命令",
  "tool.label.generic": "使用工具",
  "tool.label.readShellOutput": "读取输出",
  "tool.label.stopShell": "停止命令",
  "tool.label.webSearch": "搜索网络",
  "tool.label.webFetch": "获取网页",
  "tool.label.httpRequest": "发起请求",
  "tool.label.loadSkill": "加载技能",
  "tool.label.readSkillResource": "技能文件",
  "tool.label.proposeSkill": "提议技能",
  "tool.label.delegateTask": "调用子代理",
  "tool.label.askUser": "提问",
  "tool.label.searchMemory": "检索记忆",
  "tool.label.searchConversations": "检索会话",
  "tool.label.searchTools": "查找工具",
  "tool.label.createSchedule": "创建定时任务",
  "tool.label.deleteSchedule": "删除定时任务",
  "tool.label.createGoal": "设定目标",
  "tool.label.getGoal": "读取目标",
  "tool.label.reportGoalOutcome": "汇报目标",
  "tool.label.read": "读取",
  "tool.label.edit": "编辑",
  "tool.label.write": "写入",
  ...
  "tool.label.lsp": "LSP",
  "tool.label.applyPatch": "应用补丁",
  "tool.label.enterPlanMode": "进入计划模式",
  "tool.label.setPlan": "更新计划",
  "tool.label.exitPlanMode": "请求计划批准",
