...
export const zh: Record<string, string> = {
  ...
  "tools.preview.pending.scheduling": "保存中…",
  ...
  "tools.preview.idle.noSchedules": "（没有定时任务）",
  ...
  "tools.output.beyond_other": "还有 {{count}} 行 —— 请打开终端视图",
