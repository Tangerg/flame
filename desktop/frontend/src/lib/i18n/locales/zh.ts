export const zh: Record<string, string> = {
  ...
  "providers.setup.steps": "选一个提供商，粘贴它的 API 密钥，然后点“保存并测试”。开始使用只需要这一步。",
  ...
  "settings.notifications.permission.granted": "Flame 在后台时，运行完成、失败或需要你处理时会显示通知。",
  "settings.notifications.permission.default": "Flame 会在第一次需要通知你时请求权限。",
  "settings.notifications.permission.denied": "已被系统阻止。请在“系统设置 › 通知”中允许 Flame 后再开启。",
