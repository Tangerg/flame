export const zh: Record<string, string> = {
  ...
  "goal.stopped.runBudget": "已达运行次数上限",
  "goal.stopped.costBudget": "已达成本上限",
  "goal.stopped.stepBudget": "已达步数上限",
  "goal.stopped.pricingUnavailable": "模型价格不可用",
  ...
  "settings.accentTint.sub": "面板、井和 chip 带多少主色的色相。",
  "settings.accentTint.off": "关",
  "settings.accentTint.soft": "轻",
  "settings.accentTint.standard": "标准",
