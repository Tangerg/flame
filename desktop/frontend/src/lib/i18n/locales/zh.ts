export const zh: Record<string, string> = {
  ...
  "composer.mention.truncated": "仅在本项目的前 {{count}} 个文件中搜索",
  ...
  "settings.notifications.permission.default": "Flame 会在第一次需要通知你时请求权限。",
  "settings.notifications.permission.denied":
    "已被系统阻止。请在“系统设置 › 通知”中允许 Flame 后再开启。",
  "settings.notifications.permission.unsupported": "此平台不支持系统通知。",
