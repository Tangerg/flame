export const zh: Record<string, string> = {
  ...
  "approval.what.search": "执行搜索",
  "approval.what.webSearch": "执行网络搜索",
  "approval.what.subagent": "委派给子智能体",
  "approval.what.generic": "执行 {{tool}}",
  "session.regenerate.switchedAway": "重新生成完成前已切换会话 —— 没有重新发送任何内容。",
  "session.restore.files": "工作区文件已恢复到该检查点。",
  "session.restore.both": "对话与文件已恢复到该检查点。",
  "session.restore.history": "对话已回退到该检查点。",
  "session.restore.noCheckpoint": "首轮之前没有检查点 —— 文件保持原样。",
  "sessionSearch.label": "跳转到会话",
  "sessionSearch.placeholder": "搜索会话…",
  "sessionSearch.empty.title": "没有匹配的会话",
  "sessionSearch.empty.sub": "试试标题里的一部分。",
  ...
  "workIndex.action.addProject": "添加项目",
  ...
  "composer.placeholder": "描述你要做的事，@ 引用文件或符号",
  ...
  "composer.model.maxInput": "最大输入 {{tokens}}",
  "composer.model.maxOutput": "最大输出 {{tokens}}",
  "composer.model.inputModalities": "输入 {{modalities}}",
  "composer.model.outputModalities": "输出 {{modalities}}",
  "composer.model.reasoning": "支持思考",
  "composer.model.reasoningLevels": "思考 {{levels}}",
  "composer.model.toolUse": "工具调用",
  "composer.model.structuredOutput": "结构化输出",
  "composer.model.knowledgeCutoff": "知识截至 {{cutoff}}",
  "composer.attachImage": "添加图片",
  "composer.attachImage.unsupported": "该模型不支持图片",
  "composer.action.send": "发送",
  "composer.action.stop": "停止",
  "composer.action.steer": "引导正在运行的回合",
  "composer.paste.lines_other": "已粘贴 · {{count}} 行",
  "composer.paste.chars_other": "已粘贴 · {{count}} 字符",
  ...
  "message.mermaid.copy": "复制 Mermaid",
  "message.mermaid.copied": "已复制",
  "message.mermaid.source": "Mermaid 源代码",
  ...
  "plan.progress": "第 {{current}} / {{total}} 步",

  "tools.preview.idle.noChanges": "没有可显示的改动",
  "tools.patch.created": "已创建",
  "tools.patch.edited": "已编辑",
  "tools.patch.deleted": "已删除",
  "tools.patch.moved": "已移动",
  "tools.preview.pending.matching": "匹配中…",
  "tools.preview.pending.querying": "查询中…",
  "tools.preview.pending.running": "运行中…",
  "tools.preview.pending.delegating": "子智能体处理中…",
  ...
  "tools.preview.idle.noReply": "（无回复）",
  "tools.overflow.more": "还有 {{count}} 项",
  "tools.preview.pending.recalling": "回忆中…",
  "tools.preview.pending.loadingTools": "加载工具…",
  "tools.preview.pending.requesting": "请求中…",
  "tools.preview.pending.fetching": "抓取中…",
  "tools.preview.idle.noMemories": "（没有回忆到内容）",
  "tools.preview.idle.noConversations": "（此前没有提到过）",
  "tools.preview.idle.noTools": "（没有加载工具）",
  "tools.preview.idle.noResponse": "（没有响应）",
  "tools.preview.idle.noPage": "（没有内容）",
  "tools.preview.idle.emptyBody": "（响应体为空）",
  "tools.http.headers_other": "{{count}} 个响应头",
  "inbox.title": "收件箱",
  "inbox.waiting": "{{count}} 项在等你",
  "inbox.ask.approval": "待批准",
  "inbox.ask.question": "待回答",
  "inbox.empty.title": "没有在等你的事",
  "inbox.empty.sub": "会话停下来问你什么时,会出现在这里。",
  "goal.summary.active": "进行中的目标",
  "goal.summary.paused": "已暂停的目标",
  "goal.summary.blocked": "目标已停滞",
  "goal.summary.completing": "目标收尾中",
  "goal.mode.label": "Goal",
  "goal.mode.clear": "退出 Goal 模式",
  ...
  "goal.edit.label": "目标",
  "goal.edit.save": "保存",
  "goal.edit.saving": "正在保存…",
  "goal.error.start": "无法开启目标模式",
  "goal.error.attachmentsUnsupported": "Goal 目标暂不支持附件",
  "goal.error.pause": "无法暂停目标",
  "goal.error.resume": "无法继续目标",
  "goal.error.clear": "无法清除目标",
  "goal.error.update": "无法更新目标",
  "slash.goal": "设定一个让智能体持续追求的目标",
  "goal.error.unavailable": "现在无法设定目标 —— 该运行时可能不支持目标，或者已有一个在运行",
  "goal.replace.title": "替换当前目标？",
  "goal.replace.body": "“{{objective}}”将就此结束，对话会保留。",
  "goal.replace.confirm": "替换目标",
  "tools.grep.matchCount_other": "{{count}} 处",
  "tools.overflow.matches_other": "还有 {{count}} 个匹配",
  "tools.output.label": "工具输出",
  "tools.output.copy": "复制输出",
  "tools.output.copied": "已复制",
  "tools.output.collapse": "收起",
  "tools.overflow.truncated": "已被运行时截断",
  "tools.group.calls_other": "{{count}} 次调用",
  "common.remove": "移除",
  "common.loading": "加载中",
  "common.retry": "重试",
  "tasks.header": "任务",
  ...
  "status.notifications.unread_other": "{{count}} 条未读通知",
  "session.row.titleLabel": "会话标题",
  "session.untitled": "未命名会话",
  "session.action.pin": "置顶",
  "session.action.unpin": "取消置顶",
  "session.action.rename": "重命名",
  "session.action.fork": "复刻",
  "session.action.delete": "删除",
  "session.delete.title": "删除这个会话？",
  "session.delete.body": "“{{title}}”及其中的全部内容都会消失，且无法恢复。",
  ...
  "welcome.title": "我们应该构建什么？",
  "welcome.projectTitle": "我们应该在 <projectSelect>{{project}}</projectSelect> 中构建什么？",
  "composer.project.choose": "选择项目",
  "composer.project.select": "选择你的项目",
  "composer.project.tooltip": "选择本次对话要使用的项目",
  "composer.project.change": "更改项目：{{project}}",
  "composer.project.add": "新建项目",
  "composer.project.required": "选择项目后继续",
  "providers.setup.title": "接入一个模型 provider",
  "providers.setup.sub": "配置模型 provider 即可开始对话 —— 是否需要认证由 provider 自身决定。",
  "providers.setup.action": "去配置 provider",
  ...
  "settings.appearance.hero": "主题、明度、字体和动效共同定义 Flame 的工作质感。",
  "context.usage.aria": "上下文用量：{{percent}}%",
  "context.usage.label": "背景信息窗口：",
  "context.usage.statusFull": "{{percent}}% 已用",
  "context.usage.statusLeft": "{{percent}}% 已用（剩余 {{remaining}}%）",
  "context.usage.tooltip": "已用 {{used}} 标记，共 {{window}}",
  "usage.range.all": "全部",
  ...
  "usage.error": "无法加载用量。",
  "usage.empty": "暂无用量",
  "usage.empty.sub": "运行会话后,这里会显示 token 花费。",
  "usage.total": "合计",
  "usage.cache": "缓存读取",
  "usage.cacheWrite": "缓存写入",
  "usage.reasoning": "推理",
  "usage.sessions_other": "{{count}} 个会话",
  "usage.runs_other": "{{count}} 次运行",
  "usage.byProvider": "按提供方",
  "usage.byModel": "按模型",
  "usage.byDay": "按天",
  "mcp.add": "添加服务器",
  "mcp.saveEffect": "保存后，已启用的服务器将在后台连接；是否就绪请查看服务器状态。",
  "mcp.save": "保存",
  "mcp.saving": "保存中…",
  "mcp.delete": "删除",
  "mcp.test": "测试",
  ...
  "mcp.form.env.keep": "留空以保留已存环境变量",
  "mcp.form.env.clear": "移除已保存的环境变量",
  "mcp.form.env.targetChanged": "进程目标已改变，请输入新的环境变量或明确移除已保存的值。",
  ...
  "mcp.form.auth.clear": "移除已保存的授权信息",
  "mcp.form.auth.originChanged": "端点来源已改变，请输入新的授权信息或明确移除已保存的值。",
  "mcp.form.auth.aria": "授权令牌",
  "mcp.form.headers": "请求头 — KEY=value，每行一个",
  "mcp.form.headers.placeholder": "X-API-Key=…",
  "mcp.form.headers.keep": "留空以保留已存请求头",
  "mcp.form.headers.clear": "移除已保存的请求头",
  "mcp.form.headers.originChanged": "端点来源已改变，请输入新的请求头或明确移除已保存的值。",
  ...
  "mcp.import.hint": "粘贴 MCP 客户端配置块 — “mcpServers” 下的一个或多个服务器。",
  "mcp.import.confirm": "导入",
  "mcp.importing": "导入中…",
  "mcp.import.ok_other": "已导入 {{count}} 个服务器",
  ...
  "approvals.mode.safe.desc": "每次编辑或命令前都询问。",
  "approvals.mode.balanced.desc": "自动放行编辑；运行命令前询问。",
  "approvals.mode.auto.desc": "全部自动执行，不询问。",
  ...
  "hooks.intro":
    "钩子在一个 turn 的固定时点跑你自己的命令——工具执行前、prompt 提交后、压缩前。全局钩子（~/.flame）始终运行；项目的钩子只在你信任它后才运行。",
  ...
  "hooks.empty": "未配置钩子",
  "hooks.empty.sub": "在 ~/.flame/hooks.json（全局）或 <项目>/.flame/hooks.json 中添加钩子。",
  ...
  "providers.embedding.desc":
    "可选地改善 Agent Memory 排序。请选择支持嵌入的 Provider；关闭时 Memory 仍使用关键词匹配。 对后续搜索生效。",
  ...
  "settings.font.ui": "界面字体",
  "settings.font.ui.sub": "标签、菜单和按钮使用的字体。",
  "settings.font.code": "代码字体",
  "settings.font.code.sub": "差异、终端和代码块使用的字体。",
  "settings.font.size": "界面字号",
  "settings.font.size.sub": "全局正文字号基准。",
  "settings.font.smoothing": "字体平滑",
  "settings.font.smoothing.sub": "macOS 抗锯齿。笔画更细，边缘更柔和。",
  ...
  "settings.connection.sub": "Flame Runtime 的地址。应用后桌面端将切换连接。",
  ...
  "settings.connection.status.unhealthy": "不可用",
  "settings.connection.status.unavailable": "无法连接",
  "settings.connection.status.timeout": "Runtime 未能及时响应。",
  "settings.connection.status.refresh": "刷新",
  "settings.connection.status.server": "服务",
  "settings.connection.status.protocol": "协议",
  "settings.connection.status.checks": "异常检查",
  ...
  "approval.action.allowSession": "在本会话中允许",
  "approval.action.allowProject": "在此项目中允许",
  "approval.action.allowGlobal": "始终允许",
  ...
  "timeline.latestCalls": "最新调用",
  "timeline.olderCalls": "更早调用",
  "timeline.modelCall.started": "调用中",
  "timeline.modelCall.completed": "已完成",
  "timeline.modelCall.failed": "失败",
  "timeline.modelCall.unknown": "结果未知",
  "timeline.recentWindow": "当前显示最近 {{count}} 条记录",
  "timeline.kind.compaction": "上下文已压缩",
  "timeline.executionDuration": "执行耗时（不含审批等待）",
  ...
  "search.aria": "搜索模式",
  "search.scope": "在会话工作区中使用正则搜索",
  "search.prompt.title": "搜索此工作区",
  "search.matches_other": "{{count}} 个匹配",
  "search.overflow_other": "还有 {{count}} 个匹配未显示 —— 请缩小查询范围。",
  ...
  "tools.family.network": "网络",
  "tools.family.skills": "技能",
  "tools.family.delegation": "委派",
  "tools.family.plan": "计划",
  "tools.family.recall": "回溯",
  "tools.family.schedules": "定时",
  "tools.family.goals": "目标",
  ...
  "schedules.unavailable.sub": "已连接的运行时尚未提供定时运行能力。",
  ...
  "schedules.form.cron": "Cron 表达式",
  "schedules.form.cwd": "工作目录(可选)",
  "schedules.preset.hourly": "每小时",
  ...
  "knowledge.scope.projectRoot": "项目根目录",
  "knowledge.scope.home": "主目录",
  "knowledge.empty.title": "暂无知识",
  "knowledge.empty.sub": "运行时为 agent 维护的 FLAME.md 文件会显示在这里。",
  ...
  "file.error.sub": "它可能已移动，或位于工作区之外。",
  ...
  "convExport.notFlame": "不是 Flame 会话导出 —— 请选择通过「导出对话」导出的 JSON 文件。",
  ...
  "announce.running": "正在回答",
  "announce.needsInput": "等待你的回答",
  "announce.finished": "回答完成",
  "announce.error": "本轮失败。",
  "announce.canceled": "本轮已停止",
  ...
  "skillLibrary.archiveEffect": "归档影响后续技能解析，不会移除会话中已有的指令。",
  "skillLibrary.archive": "归档",
  "skillLibrary.restore": "恢复",
  "skillLibrary.empty.title": "还没有技能",
  "skillLibrary.empty.sub": "智能体提议、你批准后的技能会保存在这里。",
  ...
  "skillProposals.scope.project": "项目",
  "skillProposals.scope.user": "个人",
  "skillProposals.revises": "覆盖现有技能",
  "skillProposals.origin.requested": "你要求生成的",
  "skillProposals.origin.mined": "从你的会话中提炼",
  ...
  "agentMemory.sub": "{{pending}} 条待审 · {{active}} 条生效",
  "agentMemory.scope.project": "项目",
  "agentMemory.scope.user": "用户",
  "agentMemory.section.pending": "待审阅",
  "agentMemory.section.active": "生效中",
  "agentMemory.approve": "批准",
  "agentMemory.reject": "拒绝",
  "agentMemory.pin": "置顶",
  "agentMemory.unpin": "取消置顶",
  "agentMemory.edit": "编辑记忆",
  "agentMemory.editAria": "编辑记忆内容",
  "agentMemory.delete": "删除记忆",
  "agentMemory.save": "保存",
  "agentMemory.cancel": "取消",
  "agentMemory.add": "添加记忆",
  "agentMemory.add.placeholder": "一条值得跨会话记住的持久事实…",
  "agentMemory.origin.auto": "挖掘",
  "agentMemory.origin.user": "你",
  "agentMemory.fromSession": "来自某次会话",
  "agentMemory.pinnedLabel": "已置顶",
  "agentMemory.updated": "已更新",
  "agentMemory.empty.title": "还没有记忆",
  "agentMemory.empty.sub":
    "智能体从你的会话中挖掘出的事实会在这里等待审阅；批准后的会在后续轮次被召回。",
  "agentMemory.unavailable.title": "智能体记忆不可用",
  "agentMemory.unavailable.sub": "当前运行时未启用智能体记忆审阅能力。",
  ...
  "rpcError.timeout": "请求模型提供方超时 —— 检查网络后重试。",
  "rpcError.provider_unavailable": "模型提供方暂时不可用 —— 稍后重试。",
  ...
  "rpcError.denied_by_user": "你拒绝了这个操作。",
  ...
  "rpcError.mcp_authorization_failed": "登录未完成，请重试。",
  "rpcError.mcp_authorization_attempt_not_found": "本次登录尝试已过期，请重新开始。",
  "rpcError.mcp_dial_failed": "连不上这个服务器 —— 检查命令或 URL 后重试。",
  "rpcError.provider_not_configured": "请先完成 provider 配置。",
  "rpcError.provider_test_failed": "供应方连不上，或拒绝了这次测试请求。",
  "rpcError.skill_not_found": "该技能已不在库中。",
  "rpcError.skill_unavailable": "该技能的文档无法读取——检查它指向的文件。",
  "rpcError.revision_conflict": "已有他人先一步改动——重新加载后再试。",
  "rpcError.mcp_server_not_found": "该服务器已不在配置中。",
  "rpcError.mcp_server_already_exists": "同名服务器已配置。",
  "rpcError.mcp_server_disabled": "该服务器已关闭——请先启用。",
  "rpcError.schedule_not_found": "该计划任务已不存在。",
  "rpcError.path_outside_root": "该路径在会话工作目录之外。",
  "rpcError.unsupported_mime": "这里不支持该文件类型。",
  "rpcError.interrupt_not_open": "该请求已不再等待回答。",
  "rpcError.idempotency_conflict": "同一请求此前已用不同内容提交过。",
  ...
  "composer.error.readImages_other": "无法读取 {{count}} 张图片",
  "tool.action.generic": "调用工具",
  "tool.action.shell": "运行命令",
  "tool.action.readShellOutput": "读取输出",
  "tool.action.stopShell": "停止命令",
  "tool.action.read": "读取文件",
  "tool.action.applyPatch": "应用补丁",
  "tool.action.grep": "搜索文本",
  "tool.action.glob": "查找文件",
  "tool.action.lsp": "检查代码",
  "tool.action.webSearch": "搜索网页",
  "tool.action.webFetch": "获取网页",
  "tool.action.httpRequest": "发送请求",
  "tool.action.listSkills": "列出技能",
  "tool.action.loadSkill": "加载技能",
  "tool.action.readSkillResource": "读取技能文件",
  "tool.action.proposeSkill": "提议技能",
  "tool.action.delegateTask": "委派任务",
  "tool.action.askUser": "询问用户",
  "tool.action.enterPlanMode": "进入计划模式",
  "tool.action.setPlan": "更新计划",
  "tool.action.exitPlanMode": "请求批准计划",
  "tool.action.searchMemory": "搜索记忆",
  "tool.action.searchConversations": "搜索对话",
  "tool.action.searchTools": "查找工具",
  "tool.action.readToolResult": "读取已存输出",
  "tool.action.listSchedules": "列出计划任务",
  "tool.action.createSchedule": "创建计划任务",
  "tool.action.deleteSchedule": "删除计划任务",
  "tool.action.createGoal": "创建目标",
  "tool.action.getGoal": "读取目标",
  "tool.action.reportGoalOutcome": "报告目标结果",
  "tool.doing.generic": "正在使用工具",
  "tool.done.generic": "使用工具",
  "tool.doing.shell": "正在执行",
  "tool.done.shell": "执行",
  "tool.doing.readShellOutput": "正在读取输出",
  "tool.done.readShellOutput": "读取输出",
  "tool.doing.stopShell": "正在停止命令",
  "tool.done.stopShell": "停止命令",
  "tool.doing.read": "正在读取",
  "tool.done.read": "读取",
  "tool.doing.applyPatch": "正在应用补丁",
  "tool.done.applyPatch": "应用补丁",
  "tool.doing.grep": "正在搜索",
  "tool.done.grep": "搜索",
  "tool.doing.glob": "正在查找文件",
  "tool.done.glob": "查找文件",
  "tool.doing.lsp": "正在分析代码",
  "tool.done.lsp": "分析代码",
  "tool.doing.webSearch": "正在搜索网络",
  "tool.done.webSearch": "搜索网络",
  "tool.doing.webFetch": "正在获取网页",
  "tool.done.webFetch": "获取网页",
  "tool.doing.httpRequest": "正在发起请求",
  "tool.done.httpRequest": "发起请求",
  "tool.doing.listSkills": "正在列出技能",
  "tool.done.listSkills": "列出技能",
  "tool.doing.loadSkill": "正在加载技能",
  "tool.done.loadSkill": "加载技能",
  "tool.doing.readSkillResource": "正在读取技能文件",
  "tool.done.readSkillResource": "读取技能文件",
  "tool.doing.proposeSkill": "正在提议技能",
  "tool.done.proposeSkill": "提议技能",
  "tool.doing.delegateTask": "正在调用子代理",
  "tool.done.delegateTask": "调用子代理",
  "tool.doing.askUser": "正在提问",
  "tool.done.askUser": "提问",
  "tool.doing.enterPlanMode": "正在进入计划模式",
  "tool.done.enterPlanMode": "进入计划模式",
  "tool.doing.setPlan": "正在更新计划",
  "tool.done.setPlan": "更新计划",
  "tool.doing.exitPlanMode": "正在请求计划批准",
  "tool.done.exitPlanMode": "请求计划批准",
  "tool.doing.searchMemory": "正在检索记忆",
  "tool.done.searchMemory": "检索记忆",
  "tool.doing.searchConversations": "正在检索会话",
  "tool.done.searchConversations": "检索会话",
  "tool.doing.searchTools": "正在查找工具",
  "tool.done.searchTools": "查找工具",
  "tool.doing.readToolResult": "正在读取暂存输出",
  "tool.done.readToolResult": "读取暂存输出",
  "tool.doing.listSchedules": "正在列出定时任务",
  "tool.done.listSchedules": "列出定时任务",
  "tool.doing.createSchedule": "正在创建定时任务",
  "tool.done.createSchedule": "创建定时任务",
  "tool.doing.deleteSchedule": "正在删除定时任务",
  "tool.done.deleteSchedule": "删除定时任务",
  "tool.doing.createGoal": "正在设定目标",
  "tool.done.createGoal": "设定目标",
  "tool.doing.getGoal": "正在读取目标",
  "tool.done.getGoal": "读取目标",
  ...
  "composer.image.preview": "查看图片",
  "composer.paste.review": "查看粘贴的文本",
  "composer.paste.title": "粘贴的文本",
  "composer.paste.save": "保存",
  "composer.paste.restore": "放回输入框",
  "composer.mention.status.loading": "正在加载项目文件…",
  "composer.mention.status.empty": "没有匹配的文件",
  "composer.mention.status.error": "无法列出项目文件",
  "composer.mention.status.no-workspace": "选择一个项目后才能引用其文件",
  "providers.apiKey.label": "API 密钥",
  "providers.baseUrl.label": "基础 URL",
  "providers.baseUrl.labelRequired": "基础 URL · 必填",
  "providers.baseUrl.required": "此提供商需要填写基础 URL 才能保存。",
  "providers.saveAndTest": "保存并测试",
  "providers.saved": "已保存",
  "providers.role.loadError": "无法加载此设置，当前值未知。",
  "providers.role.stale": "显示的是最后已知的值——刷新失败。",
  "providers.setup.steps":
    "选一个提供商，粘贴它的 API 密钥，然后点“保存并测试”。开始使用只需要这一步。",
  "providers.setup.done": "提供商已就绪。点“返回应用”即可回去——你的草稿仍在。",
  "providers.roles.heading": "模型角色",
  "settings.search.empty": "没有与“{{query}}”匹配的设置。",
  "settings.search.clear": "清除搜索",
  "startup.failed.title": "Flame 无法启动",
  "startup.failed.body": "窗口就绪前发生了错误。请重试，或复制诊断信息进行反馈。",
  "startup.failed.copy": "复制诊断信息",
  "startup.failed.copied": "已复制",
  "plugins.renderFailed.details": "详情",
  "settings.notifications": "系统通知",
  "settings.notifications.authorization.granted":
    "Flame 在后台时，运行完成、失败或需要你处理时会显示通知。",
  "settings.notifications.authorization.default": "Flame 会在第一次需要通知你时请求权限。",
  "settings.notifications.authorization.denied":
    "已被系统阻止。请在“系统设置 › 通知”中允许 Flame 后再开启。",
  "settings.notifications.authorization.unsupported": "此平台不支持系统通知。",
  "notify.finished.title": "{{product}} 已完成",
  "notify.finished.body": "智能体已完成本轮任务。",
  "notify.needsInput.title": "{{product}} 需要你处理",
  "notify.needsInput.body": "智能体正在等待你的批准或回答。",
  "notify.error.title": "{{product}} 出错了",
  "notify.error.body": "智能体运行失败。",
  "notify.canceled.title": "{{product}} 已停止",
  "notify.canceled.body": "智能体运行已取消。",
  "tools.read.notRecorded": "这次读取的内容没有被记录。打开当前文件可查看它现在的样子。",
  "tool.open.currentFile": "打开当前文件",
  "tool.open.worktreeDiff": "打开工作区差异",
  "tools.overflow.lines_other": "还有 {{count}} 行",
  "tools.output.earlier_other": "显示前面 {{count}} 行 · 共 {{total}} 行",
  "tools.output.latest": "跳到最新",
  "message.user.unfold": "显示完整消息",
  "message.user.fold": "收起",
  "composer.steer.hint": "发送后会补充到正在运行的任务中。",
  "message.mermaid.fit": "适应窗口",
  "message.mermaid.zoomIn": "放大图表",
  "message.mermaid.zoomOut": "缩小图表",
  "file.range": "第 {{start}}–{{end}} 行，共 {{total}} 行",
  "file.copyPath": "复制路径",
  "file.reveal": "在 Finder 中显示",
  "file.goToLine": "跳转到行",
  "file.goToLine.placeholder": "行号",
  "file.mode": "文件视图",
  "file.mode.rendered": "预览",
  "file.mode.source": "源码",
  "file.loadEarlier_other": "显示前面 {{count}} 行",
  "file.loadLater_other": "再显示 {{count}} 行",
  "quote.selection": "引用到消息",
  "diff.worktree.open_other": "查看工作区中 {{count}} 个已更改的文件",
  "diff.status.added": "新增",
  "diff.status.modified": "修改",
  "diff.status.deleted": "删除",
  "diff.status.renamed": "重命名",
  "diff.status.untracked": "未跟踪",
  "diff.nav.picker": "跳转到文件",
  "diff.nav.filter": "筛选已更改的文件",
  "diff.nav.none": "没有匹配的已更改文件",
  "diff.nav.previous": "上一个文件",
  "diff.nav.next": "下一个文件",
  "diff.nav.collapseAll": "折叠所有文件",
  "diff.nav.expandAll": "展开所有文件",
  "search.scope.placeholder": "文件夹或文件，例如 src/",
  "search.scope.aria": "搜索范围",
  "search.narrow": "缩小到某个文件夹",
  "session.row.more": "“{{title}}”的更多操作",
  "project.row.waiting_other": "{{count}} 个待处理",
  "settings.font.codeSize": "代码字号",
  "settings.font.codeSize.sub": "代码块、差异和工具输出。导航和控件保持界面字号。",
  "settings.font.followUi": "跟随界面",
  "dock.action.openFull": "全宽打开材料——窗口太窄，无法与对话并排显示",
  "composer.add": "添加到消息",
  ...
  "model.effort.none": "关闭",
  "model.effort.minimal": "极低",
  "model.effort.low": "低",
  "model.effort.medium": "中",
  "model.effort.high": "高",
  "model.effort.xhigh": "极高",
  "model.effort.max": "最高",
  "tools.output.find": "在输出中查找",
  "tools.output.find.none": "无匹配",
  "tools.output.find.count": "第 {{index}} / {{total}} 处",
  "tools.output.find.previous": "上一个匹配",
  "tools.output.find.next": "下一个匹配",
  "tools.output.find.close": "关闭查找",
  "common.clear": "清除",
  "file.unsupported.image": "这里暂时无法预览图片",
  "file.unsupported.binary": "这不是文本文件",
  "file.open": "打开",
