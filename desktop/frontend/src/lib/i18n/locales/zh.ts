export const zh: Record<string, string> = {
  ...
  "settings.connection.clearToken": "清除令牌",
  "settings.connection.token": "访问令牌",
  "settings.connection.tokenPlaceholder": "输入或替换令牌",
  "settings.connection.tokenHint": "仅在当前窗口中为此 Runtime 地址保留，刷新后清除。",
  ...
  "session.directory.title": "新建会话",
  "session.directory.description":
    "输入 {{endpoint}} 上 Runtime 的工作区目录。Flame 会在创建会话前验证目录。",
  "session.directory.path": "Runtime 工作区目录",
  "session.directory.create": "创建会话",
  "session.directory.browse": "浏览此电脑",
