export const en: Record<string, string> = {
  ...
  "providers.setup.steps": "Pick one provider, paste its API key, then Save & test. That is all you need to start.",
  "providers.setup.done": "A provider is ready. Use Back to app to return — your draft is still there.",
  ...
  "startup.failed.body": "Something failed before the window was ready. Retry, or copy the diagnostics to report it.",
  ...
  "settings.notifications.permission.granted": "Shown when a run finishes, fails or needs you while Flame is in the background.",
  "settings.notifications.permission.default": "Flame will ask for permission the first time it has something to tell you.",
  "settings.notifications.permission.denied": "Blocked by the system. Allow Flame in System Settings › Notifications to turn this on.",
  "settings.notifications.permission.unsupported": "This platform does not offer system notifications.",
