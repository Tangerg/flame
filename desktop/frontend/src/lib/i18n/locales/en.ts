...
export const en: Record<string, string> = {
  ...
  "tool.label.generic": "Tool",
  "tool.label.readShellOutput": "Shell output",
  "tool.label.stopShell": "Stop shell",
  "tool.label.webSearch": "Web search",
  "tool.label.webFetch": "Fetch page",
  "tool.label.httpRequest": "HTTP request",
  "tool.label.loadSkill": "Load skill",
  "tool.label.readSkillResource": "Skill file",
  "tool.label.proposeSkill": "Propose skill",
  "tool.label.delegateTask": "Delegate",
  "tool.label.askUser": "Ask",
  "tool.label.searchMemory": "Recall memory",
  "tool.label.searchConversations": "Recall conversation",
  "tool.label.searchTools": "Find tool",
  "tool.label.createSchedule": "Schedule",
  "tool.label.deleteSchedule": "Cancel schedule",
  "tool.label.createGoal": "Set goal",
  "tool.label.getGoal": "Read goal",
  "tool.label.reportGoalOutcome": "Report goal",
