export const ja: Record<string, string> = {
  ...
  "providers.setup.steps": "プロバイダーを 1 つ選び、API キーを貼り付けて「保存してテスト」を押してください。始めるにはこれだけで十分です。",
  "providers.setup.done": "プロバイダーの準備ができました。「アプリに戻る」で戻れます。下書きはそのままです。",
  ...
  "startup.failed.body": "ウィンドウの準備が整う前に問題が発生しました。再試行するか、診断情報をコピーして報告してください。",
  "startup.failed.copy": "診断情報をコピー",
  "startup.failed.copied": "コピーしました",
  "plugins.renderFailed.details": "詳細",
  "settings.notifications": "システム通知",
  "settings.notifications.permission.granted": "Flame がバックグラウンドのとき、実行の完了・失敗・入力待ちを通知します。",
  "settings.notifications.permission.default": "最初に通知が必要になったときに許可を求めます。",
  "settings.notifications.permission.denied": "システムでブロックされています。「システム設定 › 通知」で Flame を許可してください。",
  "settings.notifications.permission.unsupported": "このプラットフォームはシステム通知に対応していません。",
