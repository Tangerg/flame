export const ja: Record<string, string> = {
  ...
  "goal.stopped.runBudget": "実行回数の上限に到達",
  "goal.stopped.costBudget": "コスト上限に到達",
  "goal.stopped.stepBudget": "ステップ上限に到達",
  "goal.stopped.pricingUnavailable": "モデルの料金が不明",
  ...
  "settings.accentTint": "アクセントの色味",
  "settings.accentTint.sub": "パネル・くぼみ・チップがアクセントの色相をどれだけ帯びるか。",
  "settings.accentTint.off": "オフ",
  "settings.accentTint.soft": "弱",
