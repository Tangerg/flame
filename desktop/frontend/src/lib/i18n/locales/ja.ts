export const ja: Record<string, string> = {
  ...
  "settings.connection.clearToken": "トークンを削除",
  "settings.connection.token": "アクセストークン",
  "settings.connection.tokenPlaceholder": "トークンを入力または置換",
  "settings.connection.tokenHint":
    "このウィンドウ内の、この Runtime アドレスにのみ保持します。再読み込みで消去されます。",
  ...
  "session.directory.description":
    "{{endpoint}} の Runtime にある作業ディレクトリを入力してください。セッション作成前に検証します。",
  "session.directory.path": "Runtime の作業ディレクトリ",
  "session.directory.create": "セッションを作成",
  "session.directory.browse": "このコンピューターを参照",
