...
export const ja: Record<string, string> = {
  ...
  "tools.preview.idle.noSchedules": "（スケジュールなし）",
  ...
  "toolStats.trend": "{{name}} の呼び出しごとの推移",
  "toolStats.share": "{{name}} の所要時間の割合",
  "toolStats.calls": "{{n}} 回",
  "toolStats.slowest": "最遅 {{duration}}",
  "toolStats.failed": "{{n}} 回失敗",
  "toolStats.denied": "{{n}} 回拒否",
  "toolStats.empty.title": "まだツールは実行されていません",
  "toolStats.empty.sub": "このセッションのツール時間の内訳がここに表示されます。",
  "inbox.title": "受信箱",
  ...
  "tools.output.beyond_other": "残り {{count}} 行 — ターミナルビューで確認",
  ...
  "workspace.view.title.skillProposals": "スキル提案",
  "skillProposals.title": "スキル提案",
