export const ja: Record<string, string> = {
  ...
  "composer.model.inputModalities": "入力 {{modalities}}",
  "composer.model.outputModalities": "出力 {{modalities}}",
  "composer.model.reasoning": "思考対応",
  "composer.model.reasoningLevels": "思考レベル {{levels}}",
  "composer.model.toolUse": "ツール",
  "composer.model.structuredOutput": "構造化出力",
  "composer.model.knowledgeCutoff": "知識の更新期限 {{cutoff}}",
  ...
  "message.mermaid.copy": "Mermaid をコピー",
  "message.mermaid.copied": "コピーしました",
  "message.mermaid.source": "Mermaid ソースコード",
  ...
  "plan.progress": "ステップ {{current}} / {{total}}",

  "tools.preview.idle.noChanges": "表示する変更はありません",
  "tools.patch.created": "作成",
  "tools.patch.edited": "編集",
  "tools.patch.deleted": "削除",
  "tools.patch.moved": "移動",
  ...
  "tools.preview.pending.recalling": "想起中…",
  "tools.preview.pending.loadingTools": "ツールを読み込み中…",
  "tools.preview.pending.requesting": "リクエスト中…",
  "tools.preview.pending.fetching": "取得中…",
  "tools.preview.idle.noMemories": "（該当なし）",
  "tools.preview.idle.noConversations": "（過去に言及なし）",
  "tools.preview.idle.noTools": "（ツールなし）",
  "tools.preview.idle.noResponse": "（応答なし）",
  "tools.preview.idle.noPage": "（ページなし）",
  "tools.preview.idle.emptyBody": "（本文が空）",
  "tools.http.headers_other": "ヘッダー {{count}} 件",
  "inbox.title": "受信箱",
  "inbox.waiting": "{{count}} 件があなた待ち",
  "inbox.ask.approval": "承認",
  "inbox.ask.question": "回答",
  "inbox.empty.title": "あなた待ちのものはありません",
  "inbox.empty.sub": "セッションが確認を求めて止まると、ここに表示されます。",
  "goal.summary.active": "進行中の目標",
  "goal.summary.paused": "一時停止中の目標",
  "goal.summary.blocked": "目標が停滞中",
  "goal.summary.completing": "目標を完了処理中",
  "goal.mode.label": "Goal",
  "goal.mode.clear": "Goal モードを終了",
  "goal.action.pause": "ゴールを一時停止",
  "goal.action.resume": "ゴールを再開",
  "goal.action.clear": "ゴールをクリア",
  "goal.action.edit": "ゴールを編集",
  "goal.edit.title": "ゴールを編集",
  "goal.edit.label": "ゴール",
  "goal.edit.save": "保存",
  "goal.edit.saving": "保存中…",
  "goal.error.start": "目標を開始できませんでした",
  "goal.error.attachmentsUnsupported": "Goal の目標には添付ファイルを含められません",
  "goal.error.pause": "目標を一時停止できませんでした",
  "goal.error.resume": "目標を再開できませんでした",
  "goal.error.clear": "目標をクリアできませんでした",
  "goal.error.update": "目標を更新できませんでした",
  ...
  "goal.replace.body": "「{{objective}}」はここで終了します。会話はそのまま残ります。",
  "goal.replace.confirm": "目標を置き換える",
  "tools.grep.matchCount_other": "{{count}} 件",
  "tools.overflow.matches_other": "他 {{count}} 件の一致",
  "tools.output.label": "ツール出力",
  "tools.output.copy": "出力をコピー",
  "tools.output.copied": "コピーしました",
  "tools.output.collapse": "折りたたむ",
  "tools.overflow.truncated": "ランタイムにより切り詰められました",
  "tools.group.calls_other": "{{count}} 件の呼び出し",
  "common.remove": "削除",
  ...
  "status.notifications.unread_other": "未読の通知 {{count}} 件",
  ...
  "settings.font.ui": "UI フォント",
  "settings.font.ui.sub": "ラベル・メニュー・ボタンの書体。",
  "settings.font.code": "コードフォント",
  "settings.font.code.sub": "差分・ターミナル・コードブロックの書体。",
  "settings.font.size": "UI の文字サイズ",
  "settings.font.size.sub": "アプリ全体の基準文字サイズ。",
  "settings.font.smoothing": "フォントスムージング",
  "settings.font.smoothing.sub": "macOS のアンチエイリアス。線が細く、輪郭が柔らかくなります。",
  ...
  "settings.connection.sub": "Flame Runtime のアドレス。適用するとデスクトップが再接続します。",
  ...
  "settings.connection.status.unhealthy": "利用不可",
  "settings.connection.status.unavailable": "接続不可",
  "settings.connection.status.timeout": "Runtime が時間内に応答しませんでした。",
  "settings.connection.status.refresh": "更新",
  "settings.connection.status.server": "サーバー",
  "settings.connection.status.protocol": "プロトコル",
  "settings.connection.status.checks": "異常な検査",
  ...
  "approval.action.allowSession": "このセッションで許可",
  "approval.action.allowProject": "このプロジェクトで許可",
  "approval.action.allowGlobal": "常に許可",
  "approval.action.deny": "拒否",
  ...
  "timeline.latestCalls": "最新の呼び出し",
  "timeline.olderCalls": "以前の呼び出し",
  "timeline.modelCall.started": "呼び出し中",
  "timeline.modelCall.completed": "完了",
  "timeline.modelCall.failed": "失敗",
  "timeline.modelCall.unknown": "結果不明",
  ...
  "search.aria": "検索パターン",
  "search.scope": "セッションワークスペースを正規表現で検索",
  "search.prompt.title": "このワークスペースを検索",
  "search.matches_other": "{{count}} 件の一致",
  "search.overflow_other": "他 {{count}} 件の一致は表示されていません — 条件を絞り込んでください。",
  ...
  "tools.family.network": "ネットワーク",
  "tools.family.skills": "スキル",
  "tools.family.delegation": "委任",
  "tools.family.plan": "プラン",
  "tools.family.recall": "参照",
  "tools.family.schedules": "スケジュール",
  "tools.family.goals": "ゴール",

  "toolAction.copyCommand": "コマンドをコピー",
  "approval.fallbackText": "この操作を承認しますか？",

  "skills.title": "スキル",
  "skills.tab.available": "利用可能",
  ...
  "diff.fileCount_other": "{{count}} 個のファイル",
  ...
  "announce.running": "応答中",
  "announce.needsInput": "回答を待っています",
  "announce.finished": "応答が完了しました",
  "announce.error": "ターンが失敗しました。",
  "announce.canceled": "ターンが停止されました",
  ...
  "composer.paste.chars_other": "貼り付け · {{count}} 文字",
  ...
  "settings.appearance.hero":
    "テーマ、コントラスト、タイポグラフィ、モーションが Flame の操作感を決めます。",
  "context.usage.aria": "コンテキスト使用率: {{percent}}%",
  "context.usage.label": "コンテキストウィンドウ:",
  "context.usage.statusFull": "{{percent}}% 使用済み",
  "context.usage.statusLeft": "{{percent}}% 使用済み（残り {{remaining}}%）",
  "context.usage.tooltip": "{{used}} トークン使用、合計 {{window}}",
  "usage.range.all": "すべて",
  "usage.range.30d": "30日",
  "usage.range.7d": "7日",
  ...
  "usage.reasoning": "推論",
  "usage.sessions_other": "{{count}} セッション",
  "usage.runs_other": "{{count}} 実行",
  ...
  "hooks.intro":
    "フックはターン内の決まった時点であなた自身のコマンドを実行します — ツール実行前、プロンプト後、コンパクション時。グローバルフック（~/.flame）は常に実行され、プロジェクトのフックは信頼した後にのみ実行されます。",
  ...
  "hooks.empty.sub":
    "~/.flame/hooks.json（グローバル）または <project>/.flame/hooks.json にフックを追加してください。",
  ...
  "mcp.toolCount_other": "{{count}} 個のツール",
  ...
  "mcp.import.ok_other": "{{count}} 個のサーバーをインポートしました",
  ...
  "plan.unavailable.title": "プランを利用できません",
  "plan.unavailable.sub": "このランタイムはエージェントのプランを公開していません。",
  "skillProposals.sub": "{{count}} 件がレビュー待ち",
  "skillProposals.approve": "承認",
  "skillProposals.reject": "却下",
  "skillProposals.scope.project": "プロジェクト",
  "skillProposals.scope.user": "個人",
  "skillProposals.revises": "既存のスキルを置き換え",
  "skillProposals.origin.requested": "あなたが依頼したもの",
  "skillProposals.origin.mined": "セッションから抽出",
  "skillProposals.readBody": "手順を表示",
  ...
  "composer.error.readImages_other": "{{count}} 枚の画像を読み込めませんでした",
  "tool.action.generic": "ツール呼び出し",
  "tool.action.shell": "コマンドを実行",
  "tool.action.readShellOutput": "出力を読む",
  "tool.action.stopShell": "コマンドを停止",
  "tool.action.read": "ファイルを読む",
  "tool.action.applyPatch": "パッチを適用",
  "tool.action.grep": "テキストを検索",
  "tool.action.glob": "ファイルを検索",
  "tool.action.lsp": "コードを調査",
  "tool.action.webSearch": "ウェブを検索",
  "tool.action.webFetch": "ページを取得",
  "tool.action.httpRequest": "リクエストを送信",
  "tool.action.listSkills": "スキルを一覧表示",
  "tool.action.loadSkill": "スキルを読み込む",
  "tool.action.readSkillResource": "スキルファイルを読む",
  "tool.action.proposeSkill": "スキルを提案",
  "tool.action.delegateTask": "タスクを委任",
  "tool.action.askUser": "ユーザーに質問",
  "tool.action.enterPlanMode": "計画モードに入る",
  "tool.action.setPlan": "計画を更新",
  "tool.action.exitPlanMode": "計画の承認を求める",
  "tool.action.searchMemory": "メモリを検索",
  "tool.action.searchConversations": "会話を検索",
  "tool.action.searchTools": "ツールを検索",
  "tool.action.readToolResult": "保存済み出力を読む",
  "tool.action.listSchedules": "スケジュールを一覧表示",
  "tool.action.createSchedule": "スケジュールを作成",
  "tool.action.deleteSchedule": "スケジュールを削除",
  "tool.action.createGoal": "目標を作成",
  "tool.action.getGoal": "目標を読む",
  "tool.action.reportGoalOutcome": "目標の結果を報告",
  "tool.doing.generic": "ツールを使用中",
  "tool.done.generic": "ツールを使用",
  "tool.doing.shell": "実行中",
  "tool.done.shell": "実行",
  "tool.doing.readShellOutput": "出力を読み取り中",
  "tool.done.readShellOutput": "出力を読み取り",
  "tool.doing.stopShell": "コマンドを停止中",
  "tool.done.stopShell": "コマンドを停止",
  "tool.doing.read": "読み取り中",
  "tool.done.read": "読み取り",
  "tool.doing.applyPatch": "パッチを適用中",
  "tool.done.applyPatch": "パッチを適用",
  "tool.doing.grep": "検索中",
  "tool.done.grep": "検索",
  "tool.doing.glob": "ファイルを検索中",
  "tool.done.glob": "ファイルを検索",
  "tool.doing.lsp": "コードを解析中",
  "tool.done.lsp": "コードを解析",
  "tool.doing.webSearch": "ウェブを検索中",
  "tool.done.webSearch": "ウェブを検索",
  "tool.doing.webFetch": "ページを取得中",
  "tool.done.webFetch": "ページを取得",
  "tool.doing.httpRequest": "リクエスト送信中",
  "tool.done.httpRequest": "リクエスト送信",
  "tool.doing.listSkills": "スキルを一覧表示中",
  "tool.done.listSkills": "スキルを一覧表示",
  "tool.doing.loadSkill": "スキルを読み込み中",
  "tool.done.loadSkill": "スキルを読み込み",
  "tool.doing.readSkillResource": "スキルファイルを読み取り中",
  "tool.done.readSkillResource": "スキルファイルを読み取り",
  "tool.doing.proposeSkill": "スキルを提案中",
  "tool.done.proposeSkill": "スキルを提案",
  "tool.doing.delegateTask": "委譲中",
  "tool.done.delegateTask": "委譲",
  "tool.doing.askUser": "質問中",
  "tool.done.askUser": "質問",
  "tool.doing.enterPlanMode": "プランモードに移行中",
  "tool.done.enterPlanMode": "プランモードに移行",
  "tool.doing.setPlan": "プランを更新中",
  "tool.done.setPlan": "プランを更新",
  "tool.doing.exitPlanMode": "プラン承認を要求中",
  "tool.done.exitPlanMode": "プラン承認を要求",
  "tool.doing.searchMemory": "記憶を検索中",
  "tool.done.searchMemory": "記憶を検索",
  "tool.doing.searchConversations": "会話を検索中",
  "tool.done.searchConversations": "会話を検索",
  "tool.doing.searchTools": "ツールを検索中",
  "tool.done.searchTools": "ツールを検索",
  "tool.doing.readToolResult": "保存済み出力を読み取り中",
  "tool.done.readToolResult": "保存済み出力を読み取り",
  "tool.doing.listSchedules": "スケジュールを一覧表示中",
  "tool.done.listSchedules": "スケジュールを一覧表示",
  "tool.doing.createSchedule": "スケジュール作成中",
  "tool.done.createSchedule": "スケジュール作成",
  "tool.doing.deleteSchedule": "スケジュール削除中",
  "tool.done.deleteSchedule": "スケジュール削除",
  "tool.doing.createGoal": "目標を設定中",
  "tool.done.createGoal": "目標を設定",
  "tool.doing.getGoal": "目標を読み取り中",
  "tool.done.getGoal": "目標を読み取り",
  ...
  "composer.image.preview": "画像を表示",
  "composer.paste.review": "貼り付けたテキストを確認",
  ...
  "composer.mention.status.no-workspace": "ファイルを参照するにはプロジェクトを選択してください",
  "providers.apiKey.label": "API キー",
  "providers.baseUrl.label": "ベース URL",
  "providers.baseUrl.labelRequired": "ベース URL · 必須",
  "providers.baseUrl.required": "このプロバイダーを保存するにはベース URL が必要です。",
  "providers.saveAndTest": "保存してテスト",
  "providers.saved": "保存しました",
  "providers.role.loadError": "この設定を読み込めないため、現在の値は不明です。",
  "providers.role.stale": "最後に取得した値を表示しています（更新に失敗しました）。",
  "providers.setup.steps":
    "プロバイダーを 1 つ選び、API キーを貼り付けて「保存してテスト」を押してください。始めるにはこれだけで十分です。",
  "providers.setup.done":
    "プロバイダーの準備ができました。「アプリに戻る」で戻れます。下書きはそのままです。",
  "providers.roles.heading": "モデルの役割",
  "settings.search.empty": "「{{query}}」に一致する設定はありません。",
  "settings.search.clear": "検索をクリア",
  "startup.failed.title": "Flame を起動できませんでした",
  "startup.failed.body":
    "ウィンドウの準備が整う前に問題が発生しました。再試行するか、診断情報をコピーして報告してください。",
  "startup.failed.copy": "診断情報をコピー",
  ...
  "notify.needsInput.title": "{{product}} が入力を待っています",
  "notify.needsInput.body": "エージェントが承認または回答を待っています。",
  "notify.error.title": "{{product}} でエラーが発生しました",
  "notify.error.body": "エージェントの実行に失敗しました。",
  "notify.canceled.title": "{{product}} が停止しました",
  "notify.canceled.body": "エージェントの実行はキャンセルされました。",
  "tools.read.notRecorded":
    "この読み取りの結果は記録されていません。現在のファイルを開くと今の内容を確認できます。",
  "tool.open.currentFile": "現在のファイルを開く",
  "tool.open.worktreeDiff": "作業ツリーの差分を開く",
  "tools.overflow.lines_other": "あと {{count}} 行",
  "tools.output.earlier_other": "前の {{count}} 行を表示 · 全 {{total}} 行",
  "tools.output.latest": "最新へ移動",
  "message.user.unfold": "メッセージ全体を表示",
  "message.user.fold": "折りたたむ",
  "composer.steer.hint": "送信すると、実行中のタスクに追加されます。",
  "message.mermaid.fit": "全体表示",
  "message.mermaid.zoomIn": "図を拡大",
  "message.mermaid.zoomOut": "図を縮小",
  "file.range": "{{total}} 行中 {{start}}–{{end}} 行",
  "file.copyPath": "パスをコピー",
  "file.reveal": "Finder で表示",
  "file.goToLine": "行へ移動",
  "file.goToLine.placeholder": "行番号",
  "file.mode": "ファイル表示",
  "file.mode.rendered": "プレビュー",
  "file.mode.source": "ソース",
  "file.loadEarlier_other": "前の {{count}} 行を表示",
  "file.loadLater_other": "さらに {{count}} 行を表示",
  "quote.selection": "メッセージに引用",
  "diff.worktree.open_other": "作業ツリーで変更された {{count}} 件のファイルを確認",
  "diff.status.added": "追加",
  "diff.status.modified": "変更",
  "diff.status.deleted": "削除",
  "diff.status.renamed": "名前変更",
  "diff.status.untracked": "未追跡",
  "diff.nav.picker": "ファイルへ移動",
  "diff.nav.filter": "変更されたファイルを絞り込む",
  "diff.nav.none": "一致する変更ファイルはありません",
  "diff.nav.previous": "前のファイル",
  "diff.nav.next": "次のファイル",
  "diff.nav.collapseAll": "すべて折りたたむ",
  "diff.nav.expandAll": "すべて展開",
  "search.scope.placeholder": "フォルダーまたはファイル（例: src/）",
  "search.scope.aria": "検索範囲",
  "search.narrow": "フォルダーに絞り込む",
};
