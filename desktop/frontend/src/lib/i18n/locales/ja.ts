...
export const ja: Record<string, string> = {
  ...
  "tool.label.generic": "ツール",
  "tool.label.readShellOutput": "出力を読む",
  "tool.label.stopShell": "コマンド停止",
  "tool.label.webSearch": "ウェブ検索",
  "tool.label.webFetch": "ページ取得",
  "tool.label.httpRequest": "HTTP リクエスト",
  "tool.label.loadSkill": "スキル読込",
  "tool.label.readSkillResource": "スキルファイル",
  "tool.label.proposeSkill": "スキル提案",
  "tool.label.delegateTask": "委譲",
  "tool.label.askUser": "質問",
  "tool.label.searchMemory": "記憶を検索",
  "tool.label.searchConversations": "会話を検索",
  "tool.label.searchTools": "ツール検索",
  "tool.label.createSchedule": "スケジュール作成",
  "tool.label.deleteSchedule": "スケジュール削除",
  "tool.label.createGoal": "目標設定",
  "tool.label.getGoal": "目標取得",
  "tool.label.reportGoalOutcome": "目標報告",
  ...
  "tool.label.lsp": "LSP",
  "tool.label.applyPatch": "パッチを適用",
  "tool.label.enterPlanMode": "プランモードに入る",
  "tool.label.setPlan": "プランを更新",
  "tool.label.exitPlanMode": "プランの承認を依頼",
