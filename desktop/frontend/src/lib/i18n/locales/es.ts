export const es: Record<string, string> = {
  "recipes.error.load": "No se pudieron cargar las recetas.",
  ...
  "search.scope": "Regex sobre el espacio de trabajo de la sesión",
  "search.prompt.title": "Buscar en este espacio de trabajo",
  ...
  "search.scope.placeholder": "Carpeta o archivo, p. ej. src/",
  "search.scope.aria": "Buscar en",
  "search.narrow": "Limitar a una carpeta",
