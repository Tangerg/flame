export const es: Record<string, string> = {
  ...
  "providers.role.loadError": "No se pudo cargar este ajuste, así que su valor actual es desconocido.",
  "providers.role.stale": "Se muestra el último valor conocido: la actualización falló.",
  "providers.setup.steps": "Elige un proveedor, pega su clave de API y pulsa «Guardar y probar». Es todo lo que necesitas para empezar.",
  ...
  "startup.failed.body": "Algo falló antes de que la ventana estuviera lista. Reinténtalo o copia el diagnóstico para informarlo.",
  ...
  "settings.notifications.permission.granted": "Se muestran cuando una ejecución termina, falla o te necesita con Flame en segundo plano.",
  "settings.notifications.permission.default": "Flame pedirá permiso la primera vez que tenga algo que avisarte.",
  "settings.notifications.permission.denied": "Bloqueadas por el sistema. Permite Flame en Ajustes del Sistema › Notificaciones.",
  "settings.notifications.permission.unsupported": "Esta plataforma no ofrece notificaciones del sistema.",
