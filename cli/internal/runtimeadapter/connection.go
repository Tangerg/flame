// Package runtimeadapter adapts the public in-process runtime binding to the
...
func (r *Connection) supportsFeature(name runtimeprofile.FeatureName) bool {
	return r.profile.Supports(name)
}

func (r *Connection) requireFeature(name runtimeprofile.FeatureName) error {
