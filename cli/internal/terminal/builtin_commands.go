...
func builtinCommands() []localCommand {
	return slices.Concat(
		commandGroup(commandCategoryApplication,
			localCommand{Descriptor: CommandDescriptor{Name: "quit", Title: "leave flame", Aliases: []string{"exit"}}, Run: func(a *app, _ string) error { a.Quit(); return nil }},
		),
		...
		commandGroup(commandCategoryRuntime,
			...
			localCommand{Descriptor: CommandDescriptor{Name: "goal-update", Title: "revise the current autonomous objective", Arguments: RequiredArguments}, Available: availableWithGoals, Run: func(a *app, objective string) error { return a.UpdateGoal(objective) }},
			localCommand{Descriptor: CommandDescriptor{Name: "goal-clear", Title: "clear autonomous pursuit for this session"}, Available: availableWithGoals, Run: func(a *app, _ string) error { return a.ClearGoal() }},
