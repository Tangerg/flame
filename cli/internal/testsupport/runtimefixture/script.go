...
func demoSessions() []agent.Session {
	...
	return []agent.Session{
		{ID: "ses_demo_1", Title: "Flaky cache expiry test", Status: agent.SessionIdle, Provider: defaultProvider, Model: defaultModel, Workspace: availableWorkspace("/tmp/demo/store"), UpdatedAt: now, Revision: 7},
		{ID: "ses_demo_2", Title: "Rename the shell tool family", Status: agent.SessionIdle, Provider: defaultProvider, Model: defaultModel, Workspace: availableWorkspace("/tmp/demo/store"), UpdatedAt: now.Add(-90 * time.Minute), Revision: 3},
		{ID: "ses_demo_3", Title: "Draft the release notes", Status: agent.SessionIdle, Provider: defaultProvider, Model: defaultModel, Workspace: availableWorkspace("/tmp/demo/docs"), UpdatedAt: now.Add(-26 * time.Hour), Revision: 12},
	}
}
