...
- Only `cli` may change for this goal.
- `runtime` remains authoritative for execution, persistence, recovery,
...
- Oolong owns terminal primitives and text editing mechanics. Flame owns product
